...
**ชุดที่ใช้จริง — key visual จากดีไซเนอร์**
- `public/ads/casegame-kv-4x5.png` (1122×1402) → Feed
- `public/ads/casegame-kv-9x16.png` (941×1672) → Reels / Story

คำโฆษณาบนภาพตรวจแล้วตรงกับของจริงทุกข้อ: "100+ เคสผู้ป่วย" (จริงมี **157 เคส** published), เก็บ XP + Badge (มีจริงทั้งคู่), "เล่นฟรี ไม่มีค่าใช้จ่าย" (เล่นได้โดยไม่ต้องล็อกอินด้วยซ้ำ) และไอคอน 4 ขั้น (ซักประวัติ / ตรวจร่างกาย / สั่งตรวจ / วินิจฉัยและรักษา) ตรงกับ flow จริงของเกม

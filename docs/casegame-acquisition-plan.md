...
`public/ads/casegame-ad-4x5.png` (1080×1350, feed) และ `casegame-ad-9x16.png` (1080×1920, Reels/Story) — ภาพในกรอบมือถือแคปจากเกมจริงที่ `/sim/lc-testicular-torsion-01` โทนสีชุดเดียวกับ `components/sim/sim.css`

ของเดิมที่ยกมาจากแคมเปญ Free Trial เป็นแบนเนอร์แบรนด์ 1200×630 (สัดส่วน OG image) ซึ่งพูดเรื่องคลังข้อสอบ ไม่เกี่ยวกับเกม และลง Reels/Story ไม่ได้
...
ตัว 9:16 ยังไม่ได้ทำเป็น ad — ใช้ตอนขยายไป Reels/Story

-- ===============================================================
-- หมอรู้ — Pediatrics seed: chunk 6/10
-- Questions 101-120 of 200
...
TSH < 0.01, Free T4 4.2 (high), Free T3 12 (high), TSI/TRAb HIGH, anti-TPO + thyroid US: diffuse heterogeneous + increased vascularity', '[{"label":"A","text":"Levothyroxine"},{"label":"B","text":"Graves Disease pediatric: anti-thyroid drug FIRST-LINE (block + replace or titration) — Methimazole 0.2-0.5 mg/kg/d ÷ 1-2 doses (only PTU during pregnancy 1st trimester due to teratogenicity, methimazole preferred otherwise per AAP/ATA 2016) — duration 1-2 yr trial (remission ~25-30% pediatric — lower than adult); beta-blocker (propranolol 1-2 mg/kg/d ÷ 3-4 doses, max 60 mg/d) for symptomatic relief tachycardia/tremor first 2-4 wk; baseline + monthly LFT + CBC (rare agranulocytosis, hepatotoxicity — discontinue + alternative if occur); periodic TSH + Free T4 + Free T3 (TSH lags 6-8 wk); if treatment fails or recurs after 2-yr course → definitive therapy — RAI ablation (preferred in adolescents > 10 yr, post-puberty for fertility) OR total thyroidectomy (skilled surgeon); ophthalmopathy — most mild self-limit, severe → ophtho + steroid + selenium + RAI typically not recommended worsens; reproductive counseling adolescent female (methimazole teratogenic 1st trimester); psychosocial + school accommodation; monitor growth + puberty + bone density"},{"label":"C","text":"Surgery first-line all"},{"label":"D","text":"Discharge no treatment"},{"label":"E","text":"Antibiotic"}]'::jsonb,
  'B', 'Pediatric Graves rare, treatment more conservative than adult initially. Methimazole 1-2 yr trial (remission lower than adult). Beta-blocker symptoms. Monitor LFT/CBC. RAI or surgery if fails. AAP/ATA 2016 guideline.', NULL,
...
Birth: HIV PCR sent, awaiting result; CBC normal', '[{"label":"A","text":"No prophylaxis, breastfeed normally"},{"label":"B","text":"Perinatal HIV exposure HIGH-risk (maternal VL > 50, unsuppressed) — combination antiretroviral prophylaxis: start within 6-12 hr of birth (CRITICAL TIMING) — 3-drug ARV regimen — zidovudine + lamivudine + nevirapine (preferred) OR raltegravir-based per HIV pediatric specialist guidance, duration 6 wk; immediate consultation pediatric HIV specialist; HIV PCR DNA (NAT) at birth, 14-21 d, 1-2 mo, 4-6 mo (definitive exclusion 2 negative tests ≥ 1 mo + ≥ 4 mo); antibody at 18-24 mo confirm; AVOID breastfeeding — replacement feeding (formula) in resource-rich settings; if breastfeeding inevitable (resource-limited) → maternal ART + infant prophylaxis throughout; vaccinations standard except avoid live vaccines (BCG until HIV status known); PCP prophylaxis (TMP-SMX) start age 4-6 wk regardless of CD4 until HIV ruled out; comprehensive primary care + adherence support; partner notification + testing; mental health + social work; if infant infected — start cART immediately, comprehensive HIV care; counsel family + privacy"},{"label":"C","text":"Single-drug ZDV only"},{"label":"D","text":"No follow-up"},{"label":"E","text":"Antibiotic alone"}]'::jsonb,
  'B', 'Perinatal HIV exposure: high-risk = 3-drug prophylaxis (vs ZDV monotherapy for low-risk). Start within 6-12 hr. Duration 6 wk. Series of HIV PCR for diagnosis (Ab unreliable < 18 mo). Avoid breastfeeding in resource-rich. PCP prophylaxis. Multidisciplinary.', NULL,
  'hard', 'id', 'review',
...
Center score 4-5', '[{"label":"A","text":"No treatment needed"},{"label":"B","text":"Streptococcal Pharyngitis + Scarlet fever (GAS confirmed): antibiotic Penicillin V PO 250 mg BID-TID (< 27 kg) or 500 mg BID (≥ 27 kg) × 10 days OR Amoxicillin 50 mg/kg/d (max 1,000 mg) once daily × 10 days (similar efficacy + better adherence) OR Benzathine penicillin G 600,000 U IM single dose (< 27 kg) or 1,200,000 U (≥ 27 kg) — single shot ensures compliance; for true penicillin allergy: cephalexin (non-anaphylactic), clindamycin, azithromycin (resistance rising — verify), clarithromycin; treatment goals — prevent acute rheumatic fever (best evidence within 9 d of symptom onset), reduce suppurative complication (peritonsillar abscess, OM, sinusitis), reduce contagion (24 hr after antibiotic = not contagious — return school); supportive — analgesia/antipyretic, fluids, salt water gargle; treat household contacts ONLY if symptomatic (not routine); recurrence within months — repeat treatment same; chronic carriers (asymptomatic + Rapid+) generally NOT treated; complications — RhF, PSGN, scarlet fever, peritonsillar abscess; follow-up if persistent symptoms; tonsillectomy criteria — recurrent (Paradise criteria) — not first-line"},{"label":"C","text":"Antiviral"},{"label":"D","text":"Antifungal"},{"label":"E","text":"Discharge no antibiotic"}]'::jsonb,
  'B', 'GAS pharyngitis = treat to prevent RhF + complications. Centor score helps clinical Dx; confirm with RADT (high specificity). Penicillin or amoxicillin first-line × 10 d. Scarlet fever = GAS + erythrogenic toxin. 24 hr post-abx → return school. Penicillin allergy → cephalexin most safe.', NULL,
  'easy', 'id', 'review',
  'pediatrics', 'clinical_decision', 'id', 'peds',

-- ===============================================================
-- UPDATE: psychiatry (200 questions)
-- ===============================================================

begin;

update public.mcq_questions
set choices = '[{"label":"A","text":"Observation only"},{"label":"B","text":"Side effect monitoring"},{"label":"C","text":"Refer for surgical evaluation"},{"label":"D","text":"Hospice"},{"label":"E","text":"Antibiotic"}]'::jsonb,
...
where exam_source = 'AI-generated-board-seed'
  ...
  and scenario = 'ชายไทยอายุ 22 ปี นำส่งโดยพ่อแม่ — เริ่มแยกตัวจากเพื่อน, พูดเรื่องคนตามมาจะฆ่า, ได้ยินเสียงสั่งให้ทำร้ายตัวเอง × 6 เดือน, ผลการเรียนตก, ไม่อาบน้ำ
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Discharge — postpartum blues will resolve"},{"label":"B","text":"Postpartum Major Depression with Suicidal Ideation"},{"label":"C","text":"Antibiotic"},{"label":"D","text":"Surgery"},{"label":"E","text":"Wait + see"}]'::jsonb,
...
update public.mcq_questions
set choices = '[{"label":"A","text":"SSRI alone"},{"label":"B","text":"Stop SSRI"},{"label":"C","text":"Antibiotic"},{"label":"D","text":"Surgery"},{"label":"E","text":"Discharge — overworked"}]'::jsonb,
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Surgery"},{"label":"B","text":"Panic Disorder with Agoraphobia (DSM-5)"},{"label":"C","text":"Aspirin"},{"label":"D","text":"Beta-blocker only"},{"label":"E","text":"Avoid all activity"}]'::jsonb,
...
Panic Disorder: recurrent unexpected panic attacks + persistent worry. Often agoraphobia. Treatment: CBT + SSRI (combination most effective; either alone effective). Avoid long-term benzodiazepines. Treatment duration extended. Comorbidity common. Lifestyle modification. Outcomes 50-70% remission. Self-management skills lifelong. Multidisciplinary.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 28 ปี มา OPD ด้วยอาการ recurrent panic attacks 6 เดือน — palpitations, sweating, trembling, SOB, chest discomfort, fear of dying — last 10-20 min then resolve; เริ่มกลัวที่จะออกจากบ้าน (agoraphobia)
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Avoid all therapy"},{"label":"B","text":"Post-Traumatic Stress Disorder (PTSD) — DSM-5: exposure + intrusion + avoidance + negative cognitions/mood + hyperarousal > 1 month + functional impairment"},{"label":"C","text":"Antibiotic"},{"label":"D","text":"Surgery"},{"label":"E","text":"Refuse treatment"}]'::jsonb,
...
PTSD: exposure to traumatic event + persistent re-experiencing + avoidance + negative cognitions/mood + hyperarousal > 1 month + functional impairment. Treatment: trauma-focused psychotherapy first-line (PE, CPT, EMDR). SSRI/SNRI medication. AVOID benzodiazepines. Emerging: MDMA-assisted therapy. Comorbidity common. Suicide risk increased. Multidisciplinary care. Recovery possible.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ชายไทยอายุ 32 ปี ทหารผ่านศึก กลับจากสงคราม 2 ปี + มาด้วยอาการ flashbacks, nightmares, hypervigilance, avoidance of triggers, irritability, sleep disturbance, dissociation — เกิดหลังเหตุการณ์รุนแรง × 18 เดือน
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Stop drinking immediately at home alone"},{"label":"B","text":"Alcohol Use Disorder (AUD) Severe + Comorbid Depression"},{"label":"C","text":"Surgery"},{"label":"D","text":"Ignore"},{"label":"E","text":"Antibiotic only"}]'::jsonb,
...
AUD = chronic relapsing brain disease. Severe AUD + abrupt cessation = withdrawal (tremor, agitation, autonomic, seizure, DTs — mortality if untreated). Supervised detox + thiamine before glucose. Long-term MAT (naltrexone, acamprosate, disulfiram, topiramate). Behavioral therapy + 12-step. Comorbid depression treatment. Multidisciplinary. Liver disease workup. Modern: addiction = medical illness, treat without stigma.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ชายไทยอายุ 45 ปี ดื่มสุราหนัก × 20 ปี — มา OPD ปรึกษาเรื่องเลิกเหล้า, ดื่มวันละ ~ 12 standard drinks, ไม่สามารถหยุดได้ ก่อนหน้านี้พยายามหยุดแล้วเกิด tremor + กระสับกระส่าย
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Discharge — lifestyle choice"},{"label":"B","text":"Anorexia Nervosa, Restricting Type (DSM-5: restriction → significantly low body weight + intense fear weight gain + body image disturbance) — Severe + Medically Unstable"},{"label":"C","text":"Refuse care"},{"label":"D","text":"Surgery"},{"label":"E","text":"Hospice"}]'::jsonb,
...
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 18 ปี นำส่งโดยพ่อแม่ — น้ำหนัก 38 kg (BMI 14.2), ปฏิเสธว่าตัวเองอ้วน, จำกัดอาหารอย่างรุนแรง, ออกกำลังกายมาก, primary amenorrhea เริ่ม 12 เดือน
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Disciplinary action only"},{"label":"B","text":"ADHD Combined Type — Comprehensive Multimodal Treatment"},{"label":"C","text":"Surgery"},{"label":"D","text":"Ignore"},{"label":"E","text":"Punishment"}]'::jsonb,
...
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'เด็กชายอายุ 8 ปี นำส่งโดยพ่อแม่และครู — มีปัญหาที่โรงเรียน: ไม่นั่งนิ่ง, รบกวนเพื่อน, ไม่ทำงาน, ไม่ฟังคำสั่ง, ทำงานไม่เสร็จ, สับสน × 2 ปี
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Ignore — old age"},{"label":"B","text":"Delirium (acute fluctuating altered cognition + inattention + organic cause) — common in hospitalized elderly"},{"label":"C","text":"Restraint + sedation"},{"label":"D","text":"Discharge home"},{"label":"E","text":"Surgery"}]'::jsonb,
...
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ชายไทยอายุ 78 ปี ก่อนหน้านี้ healthy + active สังคม มาห้องฉุกเฉินด้วยอาการ acute confusion 6 ชั่วโมง — disoriented, agitated, fluctuating, hallucinations visual, ลูกบอกว่ารู้สึก like grandfather suddenly
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Ignore — stress"},{"label":"B","text":"Major Depressive Disorder, Moderate-Severe — Comprehensive Treatment"},{"label":"C","text":"Surgery"},{"label":"D","text":"Refuse care"},{"label":"E","text":"Antibiotic"}]'::jsonb,
...
MDD: ≥ 5 sx (incl depressed mood or anhedonia) × 2 wk + functional impairment. Treatment: psychotherapy + medication combination most effective. CBT + SSRI typical first-line. Multiple options for treatment-resistant (TMS, ECT, ketamine, augmentation). Lifestyle + support critical. Treatment continued 6-12 months after remission. Outcomes 60-80% respond. Multidisciplinary care.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 30 ปี มาด้วยอาการ persistent low mood + anhedonia + fatigue + insomnia + decreased appetite + weight loss 5kg + difficulty concentrating + thoughts of death × 6 weeks
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Ignore"},{"label":"B","text":"Obsessive-Compulsive Disorder (OCD) — DSM-5: obsessions + compulsions + time-consuming (> 1h/d) + distress + functional impairment"},{"label":"C","text":"Surgery"},{"label":"D","text":"Refuse care"},{"label":"E","text":"Discharge"}]'::jsonb,
...
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 28 ปี — recurrent intrusive obsessive thoughts (contamination) × 3 years + repetitive hand washing 2-3 hours/day + cannot stop + functional impairment (cannot work) + recognizes irrationality
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Ignore"},{"label":"B","text":"Alzheimer''s Dementia (insidious progressive cognitive decline + supportive imaging + ruling out reversible causes) — Comprehensive Management"},{"label":"C","text":"Surgery"},{"label":"D","text":"Discharge"},{"label":"E","text":"Antibiotic"}]'::jsonb,
...
Alzheimer''s: most common dementia. Insidious progressive cognitive decline. Diagnosis: clinical + biomarkers (emerging) + exclude reversible. Treatment: cholinesterase inhibitor + memantine + emerging anti-amyloid mAbs + non-pharmacologic. BPSD: non-pharm first; atypical antipsychotic cautiously (mortality risk). Caregiver support essential. Advance planning. Multidisciplinary. Lifestyle prevention. Long-term progressive — palliative + hospice end-stage.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 75 ปี ลูกสาวพามา — สามีบอกว่าผู้ป่วยเริ่มลืมเหตุการณ์ที่เพิ่งเกิดขึ้น × 2 ปี ค่อย ๆ แย่ลง, หลงทางในซอยที่บ้าน, ลืมชื่อหลาน, ทำอาหารไหม้, repetitive questions, agitation บางครั้ง
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Surgery"},{"label":"B","text":"Opioid Use Disorder (OUD) — Comprehensive Treatment"},{"label":"C","text":"Detox + discharge"},{"label":"D","text":"Refuse care"},{"label":"E","text":"Ignore"}]'::jsonb,
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Vaccines cause autism"},{"label":"B","text":"Autism Spectrum Disorder (ASD) — Comprehensive Multidisciplinary Care"},{"label":"C","text":"Bleach treatment"},{"label":"D","text":"Surgery"},{"label":"E","text":"Avoid all interaction"}]'::jsonb,
...
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'เด็กชายอายุ 4 ปี นำส่งโดยพ่อแม่ — concerns about development: not talking, no eye contact, repetitive behaviors (hand-flapping, lining up toys), distressed by changes in routine, sensory sensitivities (loud noises, certain textures)
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Refuse care"},{"label":"B","text":"Borderline Personality Disorder (BPD) — Comprehensive Treatment"},{"label":"C","text":"Surgery"},{"label":"D","text":"Ignore"},{"label":"E","text":"Antibiotic"}]'::jsonb,
...
BPD: pervasive instability of relationships + self-image + affects + impulsivity + functional impairment. DBT first-line, evidence-based. Medication adjunctive only. AVOID benzodiazepines. Trauma history common — trauma-informed care. Chronic suicidality requires individualized risk management. Recovery possible — 50% remit over 10 years. Multidisciplinary. Stigma + treatment access challenges.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 23 ปี recurrent ED visits for self-harm (cutting, overdose attempts), unstable relationships, intense anger, impulsivity (sex, substance, spending), chronic emptiness, fear of abandonment + 6 months
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Long-term benzodiazepine"},{"label":"B","text":"Chronic Insomnia Disorder"},{"label":"C","text":"Surgery"},{"label":"D","text":"No treatment"},{"label":"E","text":"Avoid sleep"}]'::jsonb,
...
Chronic insomnia: CBT-I first-line gold standard. Multicomponent — sleep restriction, stimulus control, cognitive restructuring, relaxation. Available online. Sleep hygiene + identifying contributors. Medications selective + short-term — DORA + melatonin agonist safer. AVOID long-term benzodiazepines (Beers in elderly). Sedating antidepressants low-dose. Lifestyle modification. Treat comorbid.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 50 ปี chronic insomnia × 6 เดือน — sleep latency 45-60 min, frequent awakenings, total sleep 4-5 hours/night + impaired daytime function — work performance suffering
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Surgery"},{"label":"B","text":"Catatonia (DSM-5 category — can occur in mood, psychotic, medical, neurological)"},{"label":"C","text":"Higher dose antipsychotic"},{"label":"D","text":"Discharge"},{"label":"E","text":"Refuse treatment"}]'::jsonb,
...
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ชายไทยอายุ 25 ปี history of schizophrenia + recent medication non-adherence — มา ED ด้วยอาการ rigid posturing, mutism, refusal to eat/drink × 3 days, immobile, waxy flexibility on exam
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Tell child to stop tics"},{"label":"B","text":"Tourette Syndrome — Comprehensive Care"},{"label":"C","text":"Surgery"},{"label":"D","text":"Punishment"},{"label":"E","text":"Ignore comorbidities"}]'::jsonb,
...
Tourette syndrome: motor + vocal tics > 1 year onset < 18 yo. Behavioral therapy (CBIT) first-line. Medication when functionally impairing. Comorbidity common (ADHD, OCD, anxiety). Often improves in adulthood (50%). Multidisciplinary care. School support + family education. Avoid stigma. Long-term but variable.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'เด็กชายอายุ 9 ปี — multiple motor tics (eye blinking, head jerking) + vocal tics (throat clearing, occasional inappropriate word — coprolalia) × 1 year + worse with stress + better with concentration
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Discharge with outpatient"},{"label":"B","text":"Suicide Risk Assessment + Management — Active Suicidal Ideation with Plan + Means + Timeline = HIGH ACUTE RISK"},{"label":"C","text":"Surgery"},{"label":"D","text":"Refuse to assess"},{"label":"E","text":"Ignore"}]'::jsonb,
...
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ชายไทยอายุ 28 ปี recent breakup + new job loss + financial difficulty + history of depression + previous SI without attempt × 2 ปี
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Stop all medications"},{"label":"B","text":"Perinatal Psychiatric Pharmacology — Comprehensive Risk-Benefit"},{"label":"C","text":"Surgery"},{"label":"D","text":"Ignore medication"},{"label":"E","text":"Refuse all care"}]'::jsonb,
...
Perinatal psychiatric pharmacology: balance untreated illness vs medication exposure. SSRI usually continued (sertraline preferred — low milk transfer). Untreated depression has serious risks. Postpartum highest risk period. Multidisciplinary care. Resources: MotherToBaby, LactMed. Shared decision-making. Modern: many medications acceptable with informed consent + monitoring.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 32 ปี G1P0 GA 28 wk underlying severe MDD on sertraline 100mg currently — concerns about medication safety in pregnancy + breastfeeding plans';

update public.mcq_questions
set choices = '[{"label":"A","text":"No biology relevant"},{"label":"B","text":"Psychiatric Neurobiology Foundation"},{"label":"C","text":"Only behavior matters"},{"label":"D","text":"Random biology"},{"label":"E","text":"No mechanism"}]'::jsonb,
...
Psychiatric neurobiology: multiple neurotransmitter systems + brain circuits + HPA axis + genetics + inflammation + neuroplasticity. Major treatments target these (SSRI, SNRI, antipsychotic, mood stabilizer, ketamine). Mechanism understanding evolving. Modern psychiatry = biopsychosocial.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามอาจารย์เรื่อง neurobiology of mental illness — neurotransmitters + circuits';

update public.mcq_questions
set choices = '[{"label":"A","text":"All same"},{"label":"B","text":"Antidepressants — Mechanisms + Clinical Use"},{"label":"C","text":"Random selection"},{"label":"D","text":"Single agent only"},{"label":"E","text":"No mechanism"}]'::jsonb,
...
Antidepressants: multiple classes + mechanisms. SSRI/SNRI first-line. Selection based on patient factors + comorbidity + side effects. Newer: ketamine/esketamine + atypical agents. Combine with psychotherapy. 4-6 weeks for full effect. Modern psychopharmacology: precision + individualized.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง psychopharmacology — antidepressant choices + mechanisms';

update public.mcq_questions
set choices = '[{"label":"A","text":"No therapy effective"},{"label":"B","text":"Evidence-Based Psychotherapy"},{"label":"C","text":"Surgery only"},{"label":"D","text":"Medication alone"},{"label":"E","text":"Random approaches"}]'::jsonb,
...
Psychotherapy: evidence-based modalities for specific disorders. CBT most studied, broadly applicable. DBT for BPD. IPT for depression + grief. Trauma-focused for PTSD. Family-based for eating disorders adolescents. Combination with medication often most effective. Therapist training + alliance critical. Cultural adaptation important. Telepsychiatry growing.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง therapy modalities — psychotherapy approaches + evidence';

update public.mcq_questions
set choices = '[{"label":"A","text":"No stigma exists"},{"label":"B","text":"Mental Health Epidemiology + Stigma"},{"label":"C","text":"Mental health irrelevant"},{"label":"D","text":"Stigma helpful"},{"label":"E","text":"No treatment exists"}]'::jsonb,
...
Mental health epidemiology + stigma: significant burden + treatment gap in Thailand + globally. Stigma major barrier. Anti-stigma interventions multiple. Cultural sensitivity. Vulnerable populations. Mental Health Act framework. Modern: integration with primary care + community + telepsychiatry + multidisciplinary care + advocacy.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง stigma + mental health epidemiology in Thailand';

update public.mcq_questions
set choices = '[{"label":"A","text":"Specialty referral only"},{"label":"B","text":"Patient-centered team-based care"},{"label":"C","text":"Avoid mental health"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random approach"}]'::jsonb,
...
Somatic Symptom Disorder: real symptoms + excessive thoughts/feelings/behaviors. Validate. Single PCP + limit repeat testing. CBT first-line. SSRI/SNRI for comorbid + chronic pain. AVOID iatrogenic harm (opioids, procedures). Function-focused. Distinguish from IAD/FND/factitious/malingering.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 45 ปี × 5 ปี — multiple persistent somatic symptoms (pain, fatigue, GI, neurological complaints) + excessive thoughts/feelings/behaviors about them (high anxiety about health, persistent worry, time/energy excessively devoted) + medical workup repeatedly negative; functional impairment

MSE: somatic preoccupation + anxiety
No identifiable single medical disease explaining all sx';

update public.mcq_questions
set choices = '[{"label":"A","text":"Continue invasive testing"},{"label":"B","text":"Limited treatment outcomes"},{"label":"C","text":"Discharge with judgment"},{"label":"D","text":"Surgery"},{"label":"E","text":"Confront aggressively"}]'::jsonb,
...
Malingering: intentional feigning for external reward (NOT DSM diagnosis). Validity testing (TOMM, SIRS). Documentation: objective findings + inconsistencies. May coexist with real disorder. Distinguish from factitious (no external) + conversion (involuntary). Forensic implications.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ชายไทยอายุ 30 ปี facing criminal charges — presents with claimed PTSD + cognitive impairment + ''voices'' affecting competency to stand trial; symptoms inconsistent on testing (improbable symptoms, exaggeration on validity testing, inconsistent across exams), atypical presentation, external incentive obvious (legal)
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Ignore complaint"},{"label":"B","text":"SSRI-Induced Sexual Dysfunction (50-70% on SSRI experience; decreased libido, anorgasmia, delayed ejaculation, ED)"},{"label":"C","text":"Stop antidepressant abruptly"},{"label":"D","text":"Surgery"},{"label":"E","text":"No discussion"}]'::jsonb,
...
SSRI Sexual Dysfunction: common (50-70%). Strategies: wait, dose reduce, switch (bupropion, mirtazapine, vortioxetine, vilazodone), augment (bupropion adjunct, PDE5i), drug holiday (controversial). Women: flibanserin/bremelanotide. Address relationship + other contributors. Shared decision.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 38 ปี on sertraline 100mg × 1 ปี for MDD (in remission) — new complaint: anorgasmia + decreased libido + marital strain; mood stable, otherwise functioning well
...
Gender Dysphoria adolescent: evidence-based gender-affirming care (WPATH SOC 8). Stepwise: social → puberty suppression → hormones → surgery (adult). Address minority stress + suicide risk. Family + school support. AVOID conversion therapy. Long-term follow-up. Multidisciplinary.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'วัยรุ่นทรานส์อายุ 14 ปี assigned female at birth — long-standing dysphoria with assigned sex, identifies as male × 5 ปี consistently, marked distress + functional impairment, supportive family seeking gender-affirming care evaluation
...
update public.mcq_questions
set choices = '[{"label":"A","text":"High-dose benzodiazepine long-term"},{"label":"B","text":"Isolated Sleep Paralysis + History of NREM Parasomnia (sleep paralysis = REM atonia persisting into wake briefly; common — 30% lifetime; benign usually)"},{"label":"C","text":"No discussion"},{"label":"D","text":"Surgery"},{"label":"E","text":"Antibiotic"}]'::jsonb,
...
Isolated Sleep Paralysis: common, benign. Education + sleep hygiene first. REM-suppressant (SSRI/TCA) if severe. NREM parasomnia: safety measures + sleep hygiene + clonazepam if injury risk. Distinguish RBD (synucleinopathy prodrome) vs NREM (childhood/young, benign).'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ชายไทยอายุ 25 ปี — recurrent isolated sleep paralysis (cannot move at sleep onset/offset) + vivid hypnagogic hallucinations + family hx of sleepwalking + sleep-related eating in adolescence (no longer); functional but anxious about episodes
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Proceed with trial regardless"},{"label":"B","text":"Two Dusky prongs"},{"label":"C","text":"Auto-NGRI defense"},{"label":"D","text":"Surgery"},{"label":"E","text":"Ignore mental illness"}]'::jsonb,
...
Civil Commitment: mental illness + imminent danger or grave disability + treatment available + least restrictive. Emergency hold → court hearing. Due process. Right to refuse medication (may require separate order). Outpatient commitment alternative. Modern: recovery-oriented + least restrictive.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ชายไทยอายุ 28 ปี severe schizophrenia + active command auditory hallucinations to harm family + recent threat with knife; refuses voluntary admission + refuses medication; family + ED team requesting involuntary hospitalization
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Restraints first-line without verbal de-escalation"},{"label":"B","text":"Acute Agitation Management — Stepwise"},{"label":"C","text":"High-dose multiple agents combination immediately"},{"label":"D","text":"Surgery"},{"label":"E","text":"Discharge without intervention"}]'::jsonb,
...
Agitation Management (Project BETA): verbal de-escalation first → voluntary medication → IM if needed → restraint last resort. Lorazepam, haloperidol, olanzapine, ziprasidone IM options. Cause-specific treatment after acute control. Trauma-informed. Special populations (pregnancy, peds, elderly).'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ชายไทยอายุ 40 ปี acute psychiatric ED — severe agitation + threatening; patient hx unknown (no records); refuses cooperation; staff + patient safety at risk; verbal de-escalation attempted but failed
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Continue medications"},{"label":"B","text":"Discontinue serotonergic agents immediately"},{"label":"C","text":"Antipsychotic for agitation"},{"label":"D","text":"Bromocriptine"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Serotonin Syndrome: serotonergic agents + Hunter criteria (clonus, hyperreflexia, autonomic, GI). Discontinue → supportive + cooling + benzodiazepine + cyproheptadine antidote. Distinguish from NMS (rigidity, hyporeflexia, antipsychotic). SSRI + tramadol classic. Washout MAOI 14d (5wk fluoxetine).'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 35 ปี on fluoxetine 40mg + recent addition of tramadol for pain — มาด้วย acute confusion, agitation, hyperreflexia, clonus (inducible + spontaneous, lower extremities), diaphoresis, hyperthermia 39.5°C, tachycardia 130, hypertension, dilated pupils, GI sx (nausea, diarrhea)
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Haloperidol IM for agitation"},{"label":"B","text":"Anticholinergic Toxicity (diphenhydramine, antipsychotic, TCA, scopolamine, jimson weed, oxybutynin, benztropine, atropine — additive)"},{"label":"C","text":"Discharge home"},{"label":"D","text":"Surgery"},{"label":"E","text":"TCA-style sodium bicarbonate without TCA"}]'::jsonb,
...
Anticholinergic Toxicity: mad/hot/dry/red/blind/full. Supportive + benzodiazepine. Physostigmine for severe delirium + agitation (NOT in TCA overdose — wide QRS asystole risk). TCA overdose: sodium bicarbonate. Distinguish from sympathomimetic, serotonin syndrome. Psychiatric eval after stabilization.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'วัยรุ่นชายอายุ 16 ปี — recreational ingestion ของ diphenhydramine 30 tablets — มา ED ด้วย delirium + visual hallucinations + flushed dry skin + dilated pupils + dry mucous membranes + urinary retention + tachycardia 130 + hyperthermia 38.5°C + bowel sounds absent

ECG: sinus tachycardia, QRS narrow
''Hot as a hare, dry as a bone, red as a beet, mad as a hatter, blind as a bat, full as a flask''';

update public.mcq_questions
set choices = '[{"label":"A","text":"Diagnose as depression relapse + increase dose"},{"label":"B","text":"FINISH mnemonic"},{"label":"C","text":"Continue cold-turkey"},{"label":"D","text":"Surgery"},{"label":"E","text":"Antibiotic"}]'::jsonb,
...
SSRI Discontinuation Syndrome: FINISH (flu-like, insomnia, nausea, imbalance, sensory zaps, hyperarousal). Short half-life > long. Restart + taper gradually OR switch to fluoxetine. Hyperbolic tapering. Distinguish from relapse. NOT addiction.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 40 ปี on paroxetine 40 mg × 2 ปี (depression in remission), self-discontinued 5 วันก่อนเพราะลืมยา — มาด้วย dizziness, electric shock sensations (brain zaps), nausea, vivid dreams, irritability, flu-like symptoms, anxiety; not depression relapse
...
TCA Overdose: cardiac toxicity (wide QRS, R in aVR). Sodium bicarbonate backbone. Benzodiazepine for seizure (NOT phenytoin — Na blocker). Norepinephrine for hypotension. AVOID class IA antiarrhythmic + physostigmine + flumazenil. Lipid emulsion for refractory. ICU. Psych eval after stabilization.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 28 ปี intentional overdose amitriptyline 50 tablets 2 ชั่วโมงก่อน — มาด้วย CNS depression, seizure × 1, anticholinergic features, hypotension, tachycardia

ECG: sinus tachycardia, QRS 160 ms (wide), R wave in aVR > 3 mm
3 R''s: Rightward R wave aVR, Right axis deviation';

update public.mcq_questions
set choices = '[{"label":"A","text":"Confront alters directly"},{"label":"B","text":"Dissociative Identity Disorder (DID — DSM-5: ≥ 2 distinct personality states + recurrent gaps in recall + symptoms cause distress; not cultural/religious)"},{"label":"C","text":"Single-session treatment"},{"label":"D","text":"Surgery"},{"label":"E","text":"No treatment"}]'::jsonb,
...
Dissociative Identity Disorder: trauma-focused phase-based treatment (ISSTD): safety/stabilization → trauma processing → integration. Long-term specialized therapy. SSRI for comorbidity. AVOID BZD + iatrogenic alter creation. Distinguish from BPD, psychosis, malingering. Trauma history universal.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'หญิงไทยอายุ 30 ปี × longstanding (childhood) — distinct identity states (alters) recurrently take control of behavior, amnesia for events when alter present, severe childhood physical + sexual abuse documented; functional impairment + distress; comorbid PTSD, depression, self-harm
...
Depersonalization/Derealization Disorder: persistent + intact reality testing. CBT + grounding first-line. SSRI for comorbid. Lamotrigine modest evidence. AVOID benzodiazepines + cannabis (worsen). Address triggers. Education. Distinguish from psychosis, panic, PTSD, substance.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ชายไทยอายุ 22 ปี × 18 เดือน — persistent depersonalization (detached from own body, observing self from outside, emotional numbing, feeling unreal) + derealization (world feels foggy, dreamlike) — intact reality testing throughout; distress + functional impairment
...
update public.mcq_questions
set choices = '[{"label":"A","text":"Single pathway"},{"label":"B","text":"Four Major Dopamine Pathways + Clinical Implications"},{"label":"C","text":"No clinical relevance"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Dopamine pathways: mesolimbic (positive sx, D2 blockade therapeutic), mesocortical (negative/cognitive sx, hypodopaminergic), nigrostriatal (EPS), tuberoinfundibular (prolactin). Atypicals + partial agonists try selective modulation.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง dopamine pathways + clinical relevance ใน schizophrenia treatment';

update public.mcq_questions
set choices = '[{"label":"A","text":"Single receptor"},{"label":"B","text":"Serotonin (5-HT) Receptors + Clinical Implications"},{"label":"C","text":"No relevance"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Serotonin receptors: 5-HT1A (anxiolytic, autoreceptor SSRI delay), 5-HT2A (atypical antipsychotic, hallucinogen, sleep), 5-HT2C (weight), 5-HT3 (antiemetic), 5-HT6/7 (research). SSRI mechanism: increased 5-HT → BDNF + neuroplasticity. Psychedelic research expanding.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง serotonin receptors + therapeutic relevance';

update public.mcq_questions
set choices = '[{"label":"A","text":"No HPA relevance"},{"label":"B","text":"HPA Axis Stress Response + Psychiatric Disorders"},{"label":"C","text":"Single hormone"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
HPA Axis: depression → hyper-cortisol, PTSD → low cortisol, childhood trauma → lifelong dysregulation. Cushing''s → 50-80% psychiatric sx. Steroid-induced. Hormonal psychiatry (PMDD, postpartum, thyroid). Inflammation hypothesis.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง HPA axis + stress + psychiatric disorders';

update public.mcq_questions
set choices = '[{"label":"A","text":"No relevance"},{"label":"B","text":"Cytochrome P450 in Psychiatric Pharmacology"},{"label":"C","text":"Single enzyme"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
P450 in psychiatry: 2D6 (many psychotropic, fluoxetine/paroxetine/bupropion inhibit), 3A4 (most drugs), 1A2 (clozapine, smoking induces), 2C19 (citalopram). Inducers (carbamazepine, smoking) → reduce levels. Pharmacogenomics emerging. Drug interactions critical.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง CYP450 + psychiatric pharmacology + drug interactions';

update public.mcq_questions
set choices = '[{"label":"A","text":"No genetic basis"},{"label":"B","text":"Genetics of Psychiatric Disorders"},{"label":"C","text":"Single gene model"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Psychiatric genetics: high heritability (schizophrenia 80%, bipolar 70-80%). Polygenic — many genes small effect. Rare highly penetrant variants (22q11, Fragile X, CNVs). GxE + epigenetics (trauma). GWAS findings. Cross-disorder shared genetics. Pharmacogenomics + precision psychiatry emerging.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง genetics of psychiatric disorders';

update public.mcq_questions
set choices = '[{"label":"A","text":"No plasticity adults"},{"label":"B","text":"Neuroplasticity + BDNF + Psychiatric Treatment"},{"label":"C","text":"Single mechanism"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Neuroplasticity + BDNF: depression ↓ BDNF; antidepressants ↑ BDNF (slow). Ketamine + psychedelics = rapid synaptogenesis (''psychoplastogens''). ECT + exercise + CBT also neuroplasticity. Adolescent critical period. Combine modalities for synergistic plasticity.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง neuroplasticity + BDNF + relevance to psychiatric treatment';

update public.mcq_questions
set choices = '[{"label":"A","text":"No relevance"},{"label":"B","text":"Sleep Architecture + Psychiatric Disorders + Medication Effects"},{"label":"C","text":"Single stage"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Sleep architecture: NREM stages + REM. Depression — decreased REM latency, ↓ SWS, REM rebound. Antidepressants suppress REM. Mania — decreased sleep need. PTSD — nightmares + prazosin. Alcohol + cannabis withdrawal — REM rebound. Aging — less SWS. Assess sleep in all psychiatric.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง sleep architecture + medication effects + psychiatric';

update public.mcq_questions
set choices = '[{"label":"A","text":"All antipsychotics same"},{"label":"B","text":"Antipsychotic Classes + Mechanisms + Side Effects"},{"label":"C","text":"Only typical effective"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Antipsychotic classes: typical (high D2), atypical (D2 + 5-HT2A — less EPS), 3rd gen (partial D2 agonist — least metabolic). Clozapine TRS + mortality + suicide reduction. LAI for adherence. Metabolic monitoring + EPS + prolactin + QTc. Black box elderly with dementia.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง antipsychotic classes + mechanisms + side effect profiles';

update public.mcq_questions
set choices = '[{"label":"A","text":"Only lithium effective"},{"label":"B","text":"Mood Stabilizers — Mechanisms + Clinical Use"},{"label":"C","text":"All same"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Mood stabilizers: lithium (gold standard, suicide reduction, narrow TI), valproate (acute mania, AVOID pregnancy NTD), lamotrigine (depression, SJS slow titration), carbamazepine (HLA-B*1502 SJS, CYP3A4 inducer). Atypicals for BP. Selection by phase + features.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง mood stabilizers + mechanisms + clinical use';

update public.mcq_questions
set choices = '[{"label":"A","text":"Routine MRI all psychiatric"},{"label":"B","text":"Neuroimaging in Psychiatry"},{"label":"C","text":"No imaging useful"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Neuroimaging in psychiatry: clinical indications (atypical, focal neuro, FEP some, dementia workup). Structural MRI > CT. Functional: amyloid + tau PET (AD), DAT scan (DLB). NO imaging diagnostic for major psychiatric. Blood-based biomarkers emerging (p-tau217, NfL).'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง neuroimaging in psychiatry + clinical use';

update public.mcq_questions
set choices = '[{"label":"A","text":"Random"},{"label":"B","text":"Limbic System + Emotional Regulation"},{"label":"C","text":"No relevance"},{"label":"D","text":"Single mechanism"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Limbic + circuits: amygdala (fear), hippocampus (memory, PTSD/depression atrophy), ACC (SCC TRD target), PFC (top-down regulation), insula (interoception), NAc (reward), DMN (rumination depression). RDoC dimensional framework. Treatments target circuits.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง limbic system + emotional regulation in psychiatric disorders';

update public.mcq_questions
set choices = '[{"label":"A","text":"Random"},{"label":"B","text":"GABA + Glutamate Balance + Psychiatric"},{"label":"C","text":"No relevance"},{"label":"D","text":"Single mechanism"},{"label":"E","text":"Surgery"}]'::jsonb,
...
GABA-glutamate: GABA inhibitory (BZD, EtOH, barbiturate target); glutamate excitatory (NMDA — ketamine antidepressant). Anxiety/depression — imbalance. Schizophrenia NMDA hypofunction. Rapid antidepressants target glutamate.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง GABA + glutamate balance + psychiatric implications';

update public.mcq_questions
set choices = '[{"label":"A","text":"Random"},{"label":"B","text":"Norepinephrine + Adrenergic System"},{"label":"C","text":"No relevance"},{"label":"D","text":"Single mechanism"},{"label":"E","text":"Surgery"}]'::jsonb,
...
NE adrenergic: alpha-1 (prazosin PTSD nightmares), alpha-2 (clonidine ADHD/anxiety, mirtazapine antagonist), beta (propranolol performance anxiety, akathisia). PTSD/panic/ADHD/depression/withdrawal all involve NE. CV monitoring stimulants/SNRI.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง norepinephrine + adrenergic system in psychiatric disorders';

update public.mcq_questions
set choices = '[{"label":"A","text":"Random"},{"label":"B","text":"Acetylcholine + Cognition + Psychiatric"},{"label":"C","text":"No relevance"},{"label":"D","text":"Single mechanism"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Acetylcholine + cognition: AD cholinergic deficit (cholinesterase inhibitors). Anticholinergic burden major iatrogenic harm elderly (Beers). Toxicity → physostigmine. Smoking + nicotine + schizophrenia. Xanomeline (KarXT) novel muscarinic schizophrenia (FDA 2024).'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง acetylcholine + cognitive function + psychiatric medications';

update public.mcq_questions
set choices = '[{"label":"A","text":"Random"},{"label":"B","text":"Inflammation + Immune System + Psychiatry — Growing Field"},{"label":"C","text":"No relevance"},{"label":"D","text":"Single mechanism"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Inflammation + psychiatry: sickness behavior, depression-inflammation link (subgroup with elevated CRP/IL-6), interferon-induced depression, schizophrenia (maternal infection), PANS/PANDAS, autoimmune encephalitis (anti-NMDA), MS psychiatric. Microbiome-gut-brain axis emerging.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง inflammation + immune system + psychiatric disorders';

update public.mcq_questions
set choices = '[{"label":"A","text":"No theoretical basis"},{"label":"B","text":"CBT Theoretical Foundations + Mechanisms"},{"label":"C","text":"Single technique"},{"label":"D","text":"Surgery"},{"label":"E","text":"No evidence"}]'::jsonb,
...
CBT: Beck cognitive triad + behavioral conditioning. Identifying automatic thoughts + cognitive restructuring + behavioral experiments + exposure. Mechanism: amygdala-PFC connectivity changes. Most studied. Disorder-specific protocols. Available online/app.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง CBT theoretical foundations + mechanisms';

update public.mcq_questions
set choices = '[{"label":"A","text":"No evidence base"},{"label":"B","text":"Psychodynamic Therapy — Theoretical Foundations + Modern Practice"},{"label":"C","text":"Single school of thought"},{"label":"D","text":"Surgery"},{"label":"E","text":"Only short-term"}]'::jsonb,
...
Psychodynamic: unconscious + defense mechanisms + transference + insight + working through. Modern: brief dynamic, MBT, TFP. Evidence base (Shedler) — effects sustained + grow. BPD, complex trauma, depression with personality, insight-seeking patients. Alliance central.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง psychodynamic therapy + theoretical foundations';

update public.mcq_questions
set choices = '[{"label":"A","text":"Stop all medications in pregnancy"},{"label":"B","text":"Pregnancy + Lactation Psychiatric Pharmacology"},{"label":"C","text":"Continue valproate"},{"label":"D","text":"Surgery"},{"label":"E","text":"Avoid SSRI absolutely"}]'::jsonb,
...
Pregnancy/lactation psychiatry: balance untreated illness vs medication. Sertraline preferred. Valproate AVOID (NTD). Lithium monitor closely. Lamotrigine acceptable. ECT safe. BZD cautious. Postpartum relapse high — continue often. MotherToBaby, LactMed. Multidisciplinary.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง psychiatric medication in pregnancy + lactation safety';

update public.mcq_questions
set choices = '[{"label":"A","text":"No monitoring needed"},{"label":"B","text":"Psychotropic Medication Monitoring"},{"label":"C","text":"Single test only"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Psychotropic monitoring: atypical metabolic (weight, glucose, lipids, BP); clozapine (ANC, troponin/CRP/ECG); lithium (level, renal, thyroid, Ca); valproate (LFT, CBC, level); carbamazepine (CBC, LFT, Na, level, HLA-B*1502); lamotrigine (SJS rash); stimulants (BP, HR).'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง psychotropic side effect monitoring + labs';

update public.mcq_questions
set choices = '[{"label":"A","text":"No predictability"},{"label":"B","text":"Risk + Protective Factors for Psychiatric Disorders"},{"label":"C","text":"Single factor"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Risk + protective factors: biological (genetics, perinatal), psychological (ACEs, attachment, cognitive style), social (poverty, isolation, discrimination). Protective: relationships, purpose, coping. Disorder-specific patterns. Life course + intersectional + cumulative.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง risk + protective factors for psychiatric disorders';

update public.mcq_questions
set choices = '[{"label":"A","text":"Adolescent brain same as adult"},{"label":"B","text":"Childhood + Adolescent Brain Development + Psychiatric Implications"},{"label":"C","text":"No critical periods"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Adolescent brain: PFC matures last (~25), limbic earlier. Imbalance → risk-taking. Critical periods + plasticity. Substance vulnerability. CAMS — SSRI + CBT for adolescent anxiety. Family + school coordination. Confidentiality with safety limits. Prevention + early intervention.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง childhood + adolescent brain development + psychiatric implications';

update public.mcq_questions
set choices = '[{"label":"A","text":"No relevance"},{"label":"B","text":"Trauma-Informed Care (TIC) — SAMHSA Framework"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Avoid all patients with trauma"}]'::jsonb,
...
Trauma-Informed Care: SAMHSA 4 R''s (Realize, Recognize, Respond, Resist retraumatization) + 6 principles (safety, trust, peer, collaboration, empowerment, cultural). Universal — assume trauma. Practical: avoid retraumatization, choice + collaboration, screening. TIC = approach; trauma treatment = specific.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง trauma-informed care + practical application';

update public.mcq_questions
set choices = '[{"label":"A","text":"No scales useful"},{"label":"B","text":"Psychiatric Assessment Tools + Rating Scales"},{"label":"C","text":"Single scale all"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Rating scales: PHQ-9 (depression), GAD-7 (anxiety), Y-BOCS (OCD), PCL-5/CAPS-5 (PTSD), YMRS (mania), C-SSRS (suicide), AUDIT/DAST (substance), MoCA (cognitive), ASRS (adult ADHD), EDE-Q (eating), WHODAS (function). Measurement-based care.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง assessment tools + rating scales in psychiatry';

update public.mcq_questions
set choices = '[{"label":"A","text":"Culture irrelevant"},{"label":"B","text":"Culture affects all aspects"},{"label":"C","text":"Single approach"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Cultural psychiatry: culture affects symptom expression + help-seeking + treatment. DSM-5 CFI tool. Cultural concepts of distress (susto, ataque, dhat, koro). Thai Buddhist context. Immigrant/refugee considerations. LGBTQ+ minority stress. Language services. Cultural humility.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง cultural psychiatry + considerations';

update public.mcq_questions
set choices = '[{"label":"A","text":"No measurement needed"},{"label":"B","text":"Measurement-Based Care (MBC) + Quality Improvement"},{"label":"C","text":"Single visit assessment"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Measurement-Based Care: routine rating scales (PHQ-9, GAD-7) guiding treatment decisions. Evidence STAR*D shows improved outcomes. Quality measures + implementation via EHR + collaborative care. Stepped care + outreach. Reimbursement incentives. Modern psychiatric quality.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง measurement-based care + quality improvement in psychiatric practice';

update public.mcq_questions
set choices = '[{"label":"A","text":"No alliance needed"},{"label":"B","text":"Therapeutic Alliance + Common Factors"},{"label":"C","text":"Technique only"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Therapeutic alliance + common factors: alliance (Bordin — bond + goals + tasks) most robust outcome predictor across modalities. Common factors theory (Wampold). Empathy + warmth + congruence (Rogers). Ruptures + repair therapeutic. Patient perspective key. Telepsychiatry comparable.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Resident ถามเรื่อง therapeutic alliance + common factors in psychotherapy';

update public.mcq_questions
set choices = '[{"label":"A","text":"Office-based weekly visits only"},{"label":"B","text":"Assertive Community Treatment (ACT) — Evidence-Based Community Care Model"},{"label":"C","text":"No multidisciplinary team"},{"label":"D","text":"Surgery"},{"label":"E","text":"Standard outpatient"}]'::jsonb,
...
Assertive Community Treatment (ACT): severe mental illness, multidisciplinary team, in vivo, 24/7, low caseload, time-unlimited, comprehensive. Reduces hospitalization, improves housing + function. Fidelity matters (DACTS). Variations FACT, CTI. Modern: recovery + trauma-informed + telepsych.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Hospital implementing assertive community treatment (ACT) program for severe mental illness';

update public.mcq_questions
set choices = '[{"label":"A","text":"ED-only response"},{"label":"B","text":"Crisis Services Continuum — Comprehensive Approach"},{"label":"C","text":"No crisis services"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Crisis services continuum: 988/1323 hotline, mobile crisis, crisis stabilization (23-72h), residential, peer respite, CIT police. Reduces ED boarding + involuntary holds. Post-crisis follow-up (caring contacts, warm handoff). ''Crisis Now'' framework. Multidisciplinary.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Healthcare system planning to reduce psychiatric ED boarding + improve crisis services';

update public.mcq_questions
set choices = '[{"label":"A","text":"No solutions available"},{"label":"B","text":"Mental Health Workforce + Access — Multi-pronged Approach"},{"label":"C","text":"Specialty referral only"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Mental health workforce shortage: task-sharing (WHO mhGAP, Friendship Bench), Collaborative Care (IMPACT), telepsychiatry, primary care integration, peer support, digital therapeutics, equity initiatives. Prevention + early intervention reduce need. Stepped care. Modern: flexible + precision delivery.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Mental health system addressing workforce shortage + access disparities';

update public.mcq_questions
set choices = '[{"label":"A","text":"No safety planning needed"},{"label":"B","text":"Inpatient Psychiatric Quality + Safety"},{"label":"C","text":"Restraints first-line"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Inpatient psychiatric safety: suicide prevention (Zero Suicide, environmental, caring contacts), violence prevention (BVC, BETA), restraint reduction (6 Core Strategies), medical safety, HBIPS quality measures, transitions of care, staff well-being. Multidisciplinary.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Hospital implementing inpatient psychiatric quality + safety program';

update public.mcq_questions
set choices = '[{"label":"A","text":"Symptom focus only"},{"label":"B","text":"Recovery-Oriented Mental Health Services"},{"label":"C","text":"Provider-directed"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Recovery-oriented services (SAMHSA): person-centered, CHIME framework (Connectedness, Hope, Identity, Meaning, Empowerment). Peer support, shared decision-making, strengths-based, WRAP, Housing First, IPS supported employment. Both ''recovery in'' + ''recovery of''.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Healthcare system developing recovery-oriented mental health services';

update public.mcq_questions
set choices = '[{"label":"A","text":"Abstinence only requirement"},{"label":"B","text":"Addiction Medicine + Harm Reduction Integration"},{"label":"C","text":"No harm reduction"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Addiction + harm reduction: chronic disease model. Harm reduction (naloxone, SSP, drug checking, safe consumption, MAT) saves lives. SBIRT + ED-initiated buprenorphine + addiction consult. Integrated co-occurring treatment. HCV/HIV treatment. Stimulant — contingency management. Stigma reduction.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Hospital integrating addiction medicine + harm reduction approaches';

update public.mcq_questions
set choices = '[{"label":"A","text":"Individual responsibility only"},{"label":"B","text":"Healthcare Worker Mental Health + Burnout"},{"label":"C","text":"No support needed"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Healthcare worker burnout: 40-60%; system-level drivers (workload, EHR, moral injury, culture). System interventions (reduce admin burden, leadership, workload), individual support (confidential care, peer support, EAP), stigma reduction (licensing), PHP for substance use, physician suicide prevention. Modern: Quintuple Aim.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Healthcare system improving mental health for healthcare workers + burnout';

update public.mcq_questions
set choices = '[{"label":"A","text":"Single specialty"},{"label":"B","text":"HIV + Stimulant Use Disorder + Depression + Social Instability — Integrated Multidisciplinary"},{"label":"C","text":"Refuse care due to non-adherence"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Complex HIV + stimulant use + depression + unstable housing: integrated multidisciplinary essential. HIV care + ART (check interactions). Cocaine — contingency management. Depression SSRI + CBT. SOCIAL DETERMINANTS foundational (Housing First). Integrated site + peer support. Trauma-informed.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 35 ปี HIV+ + cocaine use disorder + depression + medication non-adherence + unstable housing — multidisciplinary integrative management';

update public.mcq_questions
set choices = '[{"label":"A","text":"Escalating opioids"},{"label":"B","text":"Chronic Pain + OUD + PTSD + Insomnia + CVD — Integrative Multidisciplinary"},{"label":"C","text":"Single specialty"},{"label":"D","text":"Surgery first-line"},{"label":"E","text":"Random"}]'::jsonb,
...
Chronic pain + OUD + PTSD + insomnia + CVD: integrative. Buprenorphine MAT foundation (treats OUD + pain). Non-opioid chronic pain (CBT, PT, duloxetine). PTSD trauma-focused + SSRI (AVOID BZD). CBT-I for sleep. CV-safe medications (avoid TCA). Multidisciplinary + trauma-informed.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 45 ปี chronic pain (LBP) + opioid use disorder + PTSD + insomnia + comorbid CV disease — integrative care plan';

update public.mcq_questions
set choices = '[{"label":"A","text":"Polypharmacy expansion"},{"label":"B","text":"Geriatric Integrative Care — AD + Depression + Pain + Polypharmacy + Caregiver — Comprehensive"},{"label":"C","text":"No caregiver support"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
Geriatric integrative AD + depression + pain + polypharmacy + caregiver: cholinesterase inhibitor + memantine, late-life depression SSRI low/slow + ECT, chronic pain non-opioid, deprescribing (Beers/STOPP), BPSD non-pharm first, caregiver support (respite, REACH II), advance care planning, safety. Multidisciplinary.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 70 ปี Alzheimer''s + late-life depression + chronic pain + polypharmacy + caregiver burnout + advance care planning — integrative geriatric care';

update public.mcq_questions
set choices = '[{"label":"A","text":"High-dose typical antipsychotic + discharge"},{"label":"B","text":"First Episode Psychosis — Coordinated Specialty Care (CSC) Integrative Model"},{"label":"C","text":"No family involvement"},{"label":"D","text":"Cannabis maintenance"},{"label":"E","text":"Random"}]'::jsonb,
...
First Episode Psychosis — Coordinated Specialty Care (RAISE-ETP, OnTrackNY): low-dose atypical, CBTp, family education + multifamily group, IPS supported education/employment, integrated substance use (cannabis cessation critical), peer support, case management. Shorter DUP = better outcomes.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 22 ปี first episode psychosis + cannabis use + family conflict + school disruption — integrative first-episode care';

update public.mcq_questions
set choices = '[{"label":"A","text":"No family involvement"},{"label":"B","text":"Adolescent Depression with Self-Harm + Bullying + Family Conflict + School Issues — Integrative"},{"label":"C","text":"Watchful waiting with self-harm"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Adolescent depression + self-harm + bullying + family + school: TADS — combination CBT + SSRI optimal. DBT-A for self-harm. Family-based therapy (ABFT). School intervention + anti-bullying. Suicide prevention + safety planning + means restriction. Adolescent development. LGBTQ+ affirmation. Multidisciplinary.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 13 ปี depression + bullying + family conflict + decline in school + self-harm — adolescent integrative care';

update public.mcq_questions
set choices = '[{"label":"A","text":"Stop breastfeeding immediately + stop antidepressant"},{"label":"B","text":"Postpartum Depression — Perinatal Integrative Care"},{"label":"C","text":"No treatment"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Postpartum depression integrative: sertraline + brexanolone (IV) + zuranolone (oral) + IPT/CBT. Sleep deprivation address (partner, family help). Partner involvement (also paternal PPD). Social support (PSI). Address mother-infant bonding. Breastfeeding-compatible options. Multidisciplinary perinatal.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 30 ปี postpartum (4 wk) — severe MDD + breastfeeding + anxiety + sleep deprivation + partner stress — perinatal integrative care';

update public.mcq_questions
set choices = '[{"label":"A","text":"Continue dopamine agonist despite ICD"},{"label":"B","text":"Parkinson''s Disease + Multiple Neuropsychiatric Comorbidities — Integrative"},{"label":"C","text":"Single specialty"},{"label":"D","text":"Random"},{"label":"E","text":"Surgery"}]'::jsonb,
...
PD multiple neuropsychiatric: depression SSRI/SNRI/ECT, anxiety SSRI (AVOID BZD), insomnia + RBD melatonin/clonazepam, ICD from dopamine agonist (DECREASE/DISCONTINUE agonist), PD psychosis pimavanserin, PDD rivastigmine. Optimize motor. Multidisciplinary + caregiver support.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 50 ปี Parkinson''s disease + depression + anxiety + insomnia + RBD + impulse control disorder from dopamine agonist — integrative neuropsychiatric care';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"School-Based Mental Health (SBMH) — Evidence-Based Public Health Approach"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
School-Based Mental Health: MTSS (universal/selective/indicated). Evidence-based programs (Coping Cat, CBITS, PBIS, SEL). School counselors + community partnerships + telepsych. Crisis response. Equity. Reduces ED + hospitalizations + improves academic. Trauma-informed + whole child.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Healthcare system implementing school-based mental health programs for adolescents';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Opioid Epidemic + Overdose Prevention — Comprehensive Public Health"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Opioid epidemic: prescribing guidelines (CDC) + PDMP + safe disposal. MAT (buprenorphine, methadone, naltrexone) reduces mortality 50%; X-waiver removed 2023. Harm reduction (naloxone OTC, SSP, test strips, safe consumption). Comorbidity (HCV cure). Pregnancy MAT. Social determinants.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Public health system addressing opioid epidemic + overdose prevention';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Justice-Involved + Mental Illness — Sequential Intercept Model"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Justice + Mental Illness: Sequential Intercept Model (5 intercepts). CIT, mental health courts, FACT, drug courts, reentry planning. MAT + medication continuation crucial. Reduce mass incarceration. Address racial disparities. Stepping Up Initiative. Multidisciplinary.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Hospital system improving care for justice-involved individuals with mental illness';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Perinatal Mental Health — Public Health Approach"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Perinatal Mental Health: universal screening (EPDS), MCPAP for Moms consultation model, perinatal specialty + Mother-Baby Units, brexanolone/zuranolone, equity (racial disparities), beyond depression (anxiety, PTSD, OCD, bipolar, psychosis emergency), paternal PPD, integrated care, policy advocacy.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Health system addressing perinatal mental health screening + treatment access';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Mental Health Prevention + Early Intervention — Population Approach"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Mental health prevention: universal (maternal/child, schools, workplace, community) + selective (at-risk groups) + indicated (subsyndromal sx). Suicide prevention across levels. ROI high. Risk factor modification (Lancet Commission dementia). Stigma reduction + mental health literacy. WHO global priority.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Mental health system implementing prevention + early intervention strategies';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Mental Health Disparities + Equity — Comprehensive Approach"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Mental health disparities: racial/ethnic, LGBTQ+, SES, geographic, gender, age, immigration, justice. Drivers: structural racism, insurance, workforce gaps, cultural mismatch, stigma, bias, ACEs. Interventions: workforce diversity, cultural humility, telepsych, integration, peer support, social determinants, advocacy. Equity = core.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Hospital system addressing mental health disparities + equity';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Digital Mental Health Interventions — Expanding Access + Workforce Capacity"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Digital mental health: telepsychiatry, FDA digital therapeutics (Reset, Endeavor, Somryst), evidence-based apps (Sleepio CBT-I), self-help (Headspace, Woebot), online platforms (caveats). Stepped care low intensity. Workforce extension. Privacy + equity + AI emerging. Clinician guidance.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Health system implementing digital mental health interventions';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Global Mental Health — Low-Resource Setting Approach"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Global Mental Health LMIC: WHO mhGAP, task-sharing (Friendship Bench Zimbabwe, HAP India, THP Pakistan), community-integrated, cultural adaptation, IASC humanitarian guidelines, suicide prevention (pesticide regulation), SDG priority, stigma + human rights.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Hospital implementing global mental health approach + low-resource setting strategies';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Intellectual + Developmental Disability (IDD) + Mental Health — Specialized Approach"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
IDD + Mental Health: 30-50% comorbidity, underdiagnosed (diagnostic overshadowing). Informant-based + behavioral assessment. Behavioral interventions first. Adapted psychotherapy. Medication lower dose + close monitor. Address abuse/trauma higher. Specialized services (START). Caregiver support. Multidisciplinary.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Hospital implementing intellectual + developmental disability behavioral health services';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Forensic Psychiatry — Scope + Practice"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Forensic psychiatry: criminal (competency, insanity, sentencing, violence risk) + civil (capacity, commitment, disability, custody). Risk assessment tools (HCR-20, VRAG, STATIC-99R). Structured professional judgment > unstructured. Avoid dual roles. AAPL ethics. Cultural considerations.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Healthcare system implementing forensic psychiatry consultation + risk assessment';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Metabolic-Psychiatric Complex Case — Integrative"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Metabolic + psychiatric: bidirectional. SSRI/SNRI (sertraline, escitalopram, bupropion; AVOID paroxetine, TCA, high citalopram). CPAP. Diabetes mgmt (SGLT2, GLP-1 — also mood + weight benefit). Multimodal obesity. CKD med adjustments. Multidisciplinary + shared decision-making.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 55 ปี diabetes + depression + chronic kidney disease + sleep apnea + obesity + anxiety — metabolic-psychiatric integrative';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Post-Stroke Neuropsychiatric Comprehensive Care"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Post-stroke neuropsychiatric: PSD SSRI + CBT adapted, PSA SSRI (AVOID BZD), aphasia communication adaptation, vascular cognitive impairment + risk factor modification, PBA (dextromethorphan/quinidine), apathy, functional rehab, caregiver burden support, medication mgmt + minimize anticholinergic. Multidisciplinary stroke team.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 60 ปี post-stroke + aphasia + depression + anxiety + caregiver burnout + medication management — integrative neuropsychiatric rehabilitation';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Psycho-Oncology Comprehensive Care"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Psycho-oncology comprehensive: distress screening (NCCN); depression — sertraline/escitalopram/mirtazapine (AVOID fluoxetine/paroxetine/bupropion + tamoxifen); cancer fatigue (exercise, methylphenidate palliative); pain (WHO ladder + adjuvants); sleep CBT-I; chemo SE; existential meaning-centered therapy; family + survivorship. Multidisciplinary.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 45 ปี cancer (breast) + depression + chronic pain + fatigue + sleep disturbance + chemotherapy effects — psycho-oncology integrative';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Adolescent ASD with Comorbidities — Integrative"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Adolescent ASD comorbidities integrative: ADHD (stimulant low/slow or non-stim), anxiety (SSRI + adapted CBT, AVOID BZD), sleep (melatonin), irritability (risperidone/aripiprazole FDA), adolescent issues (identity, sex ed, bullying, gender), transition planning, family support, address medical (epilepsy 20-30%). Neurodiversity.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 16 ปี autism spectrum + ADHD + anxiety + sleep + family stress + school challenges — adolescent ASD integrative';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Complex PTSD with Multiple Comorbidities — Integrative Phased Treatment"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Complex PTSD integrative: phased treatment (safety/stabilization → trauma processing → integration). PE/CPT/EMDR/STAIR for trauma. SSRI + prazosin (AVOID BZD). Integrated dual diagnosis (Seeking Safety). Chronic pain — CBT + non-opioid. Dissociation — ISSTD. Address ongoing trauma + social. Trauma-informed.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 38 ปี complex PTSD + depression + dissociation + chronic pain + substance use — trauma-integrative care';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Multi-Disorder Severe Complex Case — Integrative"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Severe multi-disorder BPD + AUD + bulimia + SI + trauma + custody: DBT foundational (Stage 1 safety → trauma processing). Naltrexone AUD. CBT-E + fluoxetine bulimia. Trauma after stabilization (DBT-PE). Address chronic SI. AVOID BZD + stimulants. Custody — actual capacity. Multidisciplinary. Provider self-care.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 35 ปี severe BPD + AUD + bulimia + chronic SI + childhood trauma + custody issues — multi-disorder integrative';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Refugee Mental Health — Trauma + Culture + Resettlement Integrative"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'Refugee อายุ 35 ปี post-trauma + depression + cultural adjustment + family separation + somatic symptoms — refugee mental health integrative';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Chronic Severe Mental Illness + Multiple Comorbidities — Integrative"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
Chronic SMI + medical comorbidity: 15-20 yr reduced life expectancy. Clozapine monitoring + smoking interaction (CYP1A2). Smoking cessation (varenicline EAGLES). Metabolic — lifestyle + metformin + GLP-1 emerging + statin + DM control. CPAP. Family support (NAMI). Integrated health home. Multidisciplinary lifelong.'
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 28 ปี chronic schizophrenia + smoking + clozapine + medical comorbidity (obesity, diabetes, sleep apnea) + family burden — chronic SMI integrative';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Palliative Psychiatric Care — End-of-Life Integrative"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,
...
where exam_source = 'AI-generated-board-seed'
  and board_specialty = 'psychiatry'
  and scenario = 'ผู้ป่วยอายุ 70 ปี end-of-life + advanced cancer + depression + existential distress + family conflict + pain — palliative psychiatric integrative';

update public.mcq_questions
set choices = '[{"label":"A","text":"No intervention"},{"label":"B","text":"Resident Physician Depression + Suicidality — Integrative Approach"},{"label":"C","text":"Single approach"},{"label":"D","text":"Surgery"},{"label":"E","text":"Random"}]'::jsonb,

-- ===============================================================
-- หมอรู้ — Board seed: ศัลยศาสตร์ (surgery) — 59 MCQs
...
-- 2/2 ─── 59 mcq_questions for surgery ─────────────
...
FAST exam: positive free fluid ทั้ง 4 quadrants', '[{"label":"A","text":"CT abdomen with contrast แล้วค่อยตัดสินใจ"},{"label":"B","text":"Anterior abdominal stab wound + evisceration + hemodynamic instability + positive FAST → mandatory **emergent exploratory laparotomy** without further imaging; resuscitate enroute (2 large-bore IV, type & crossmatch 4 units PRC, give massive transfusion protocol if needed, IV antibiotics ครอบคลุม enteric flora); avoid hypothermia; damage control surgery principles if unstable"},{"label":"C","text":"Local wound exploration ใน ED ก่อน"},{"label":"D","text":"Diagnostic peritoneal lavage"},{"label":"E","text":"Observation 6 ชั่วโมง ก่อนตัดสินใจ"}]'::jsonb,
...
V/S: BP 122/74, HR 96, RR 18, Temp 38.4°C, WBC 14,500', '[{"label":"A","text":"Repeat laparoscopy + simple suture repair"},{"label":"B","text":"Major Bile Duct Injury (Strasberg E2) post-cholecystectomy — multidisciplinary referral to HPB center: (1) **Control sepsis** — IV antibiotics + percutaneous drainage of biloma + ERCP with stent or PTBD for biliary diversion; (2) **Delayed definitive reconstruction** 6-8 weeks later (allow inflammation to resolve) — **Roux-en-Y hepaticojejunostomy** is gold standard; (3) Avoid attempts at primary repair in non-HPB centers (high stricture/leak rate); (4) Long-term complications: stricture (10-30%), recurrent cholangitis, secondary biliary cirrhosis; (5) Medico-legal documentation"},{"label":"C","text":"Conservative observation only"},{"label":"D","text":"Total hepatectomy + transplant"},{"label":"E","text":"Discharge with oral antibiotic"}]'::jsonb,
  'B', 'Bile duct injury (BDI) — feared complication of cholecystectomy (0.3-0.6%). Strasberg classification A-E (E1-E5 = main duct injuries). Management principles: control sepsis (drainage + antibiotic), divert bile (ERCP/PTBD), refer to HPB specialist, delayed Roux-en-Y hepaticojejunostomy at 6-8 weeks for major injuries. Primary repair attempts by non-specialists have high failure rate (stricture, recurrent cholangitis, secondary cirrhosis). Outcome depends on time to specialist referral and surgeon expertise. A wrong — simple suture fails. C wrong — biloma + sepsis can''t observe. D wrong — transplant for end-stage liver only. E wrong — outpatient unsafe.', NULL,
  'hard', 'gi', 'review',
  'surgery', 'clinical_decision', 'gi', 'adult',
...
คำถาม: 4 ชนิด shock + hemodynamic patterns + first-line resuscitation', '[{"label":"A","text":"All shock treated same way with IV fluid"},{"label":"B","text":"**4 types of shock + patterns**: (1) **Hypovolemic** (hemorrhage, dehydration): ↓CVP, ↓PCWP, ↓CO, ↑SVR — Rx: fluid + blood; (2) **Cardiogenic** (MI, HF): ↑CVP, ↑PCWP, ↓CO, ↑SVR — Rx: revascularization (PCI), inotrope (dobutamine, milrinone), mechanical support (IABP, Impella, ECMO), avoid excess fluid; (3) **Obstructive** (PE, tamponade, tension pneumothorax): ↑CVP, varies, ↓CO, ↑SVR — Rx: relieve obstruction (thrombolysis/thrombectomy for PE, pericardiocentesis for tamponade, needle decompression for tension pneumo); (4) **Distributive** (septic, anaphylactic, neurogenic): ↓-N CVP/PCWP, ↑CO (early septic), ↓↓SVR — Rx for septic: 30 mL/kg crystalloid + broad-spectrum antibiotic + norepinephrine + source control; anaphylactic: epinephrine; neurogenic: fluid + phenylephrine. Goal: MAP > 65, urine output > 0.5 mL/kg/hr, lactate clearance, mental status"},{"label":"C","text":"Vasopressor first-line for all shock"},{"label":"D","text":"Beta-blocker for all shock"},{"label":"E","text":"Restrict fluid for all shock"}]'::jsonb,
...
คำถาม: initial management', '[{"label":"A","text":"Emergent exploratory laparotomy"},{"label":"B","text":"**Adhesive small bowel obstruction (ASBO), uncomplicated → conservative management trial**: (1) **NPO + NG decompression**; (2) **IV fluid + electrolyte correction** (K, Cl losses common); (3) **Serial abdominal exam** + serial labs (WBC, lactate); (4) **Water-soluble contrast challenge (Gastrografin)** — both diagnostic + therapeutic: contrast reaching colon within 24h = predictive of resolution + may itself promote passage (osmotic effect); 75% resolve with conservative trial; (5) **Surgery indicated** if: peritonitis, ischemia/strangulation suspected (fever, leukocytosis, lactate, CT signs — closed loop, pneumatosis, mesenteric edema), failure of conservative trial 48-72h, no transit on contrast study; (6) Surgical options: laparoscopic adhesiolysis (selected) vs open; address etiology; (7) **Prevention**: adhesion barrier (e.g., hyaluronic acid) at index surgery"},{"label":"C","text":"Discharge home with oral antibiotic"},{"label":"D","text":"Colonoscopy"},{"label":"E","text":"Sigmoid decompression tube"}]'::jsonb,
  'B', 'Adhesive SBO — most common cause of SBO in adults (60-75%). Conservative management resolves 70-80% of uncomplicated ASBO. **Bologna Guidelines (WSES) + ASBO management**: 1. Initial: NPO, NG, IV fluid, electrolyte correction 2. Identify warning signs of strangulation: fever, tachycardia, focal tenderness, lactate, WBC, CT signs (closed loop, mesenteric edema, pneumatosis, free fluid, lack of bowel wall enhancement) 3. Gastrografin challenge: 100 mL via NG, follow-up X-ray at 24h — if contrast in colon, predicts resolution + may aid passage 4. Trial 48-72h max; longer trial increases ischemia risk 5. Surgical indication: failed conservative, suspected ischemia, complete obstruction without resolution, closed loop, virgin abdomen (high malignancy risk) Strangulation = surgical emergency. A ผิด — no strangulation signs. C ผิดอย่างยิ่ง. D ผิด — small bowel not colon. E ผิด — for volvulus.', NULL,
  'easy', 'gi', 'review',
  'surgery', 'clinical_decision', 'gi', 'adult',
...
Upper GI series: ''corkscrew'' appearance of duodenum + small bowel — concerning for malrotation with midgut volvulus', '[{"label":"A","text":"Observation + NG decompression only"},{"label":"B","text":"**Neonatal midgut volvulus with malrotation — SURGICAL EMERGENCY**: (1) **Immediate resuscitation**: NG decompression, IV fluid bolus, broad-spectrum antibiotic, type & crossmatch; (2) **EMERGENT laparotomy** (within hours) for **Ladd''s procedure**: (a) detorsion (counterclockwise) of volvulus, (b) division of Ladd''s bands (peritoneal bands compressing duodenum), (c) widening of mesenteric base, (d) appendectomy (because appendix ends up LUQ → future atypical presentation), (e) place small bowel right, colon left; (3) **Assess bowel viability** — non-viable bowel resection; massive necrosis → damage control + second look 24-48h; (4) **Postop**: ICU, NG, gradual enteral; (5) **Time-critical** — bowel ischemia within hours → short gut syndrome if extensive necrosis or death"},{"label":"C","text":"Outpatient referral pediatric surgery"},{"label":"D","text":"Contrast enema"},{"label":"E","text":"Endoscopic correction"}]'::jsonb,
  ...
  'easy', 'pediatrics', 'review',
  'surgery', 'clinical_decision', 'pediatrics', 'neonate',
...
where board_specialty = 'surgery' and exam_source = 'AI-generated-board-seed'

-- ===============================================================
-- หมอรู้ — Board seed: สูติศาสตร์-นรีเวชวิทยา (ob_gyn) — 30 MCQs
...
-- 2/2 ─── 30 mcq_questions for ob_gyn ─────────────
...
US: ทารกประมาณ 1,800g, AFI ปกติ, placenta upper segment', '[{"label":"A","text":"Discharge home"},{"label":"B","text":"Preterm Labor: admit + assess; tocolytics — nifedipine 20-30mg PO loading then 10-20mg q4-6h (preferred, calcium channel blocker) OR indomethacin (< 32 wk only — ductus arteriosus closure risk); other options atosiban (oxytocin antagonist), magnesium (also neuroprotection); duration 48h to allow steroid + transfer; antenatal corticosteroid betamethasone 12mg IM × 2 doses 24h apart (mature fetal lung — reduces RDS, IVH, NEC, mortality 30-50% per Cochrane); magnesium sulfate 4-6g loading then 1-2g/hr for fetal neuroprotection (< 32 wk); GBS prophylaxis if positive or unknown; do NOT tocolyze if: chorioamnionitis, severe preeclampsia/eclampsia, abruption, IUFD, lethal anomaly, advanced labor > 5cm; counsel for NICU; consider transfer to tertiary if level 3 NICU not available"},{"label":"C","text":"Cesarean immediately"},{"label":"D","text":"Antibiotic only"},{"label":"E","text":"Discharge with progesterone"}]'::jsonb,
  'B', 'Preterm labor: contractions + cervical change before 37 wk. Management focus: delay birth 48h for steroids + neuroprotection + transfer. Tocolytics (nifedipine first-line, atosiban, MgSO4, indomethacin < 32 wk). Antenatal steroids — Liggins 1972 — major mortality reduction. Magnesium for fetal neuroprotection < 32 wk. GBS prophylaxis. Don''t tocolyze if contraindicated. Transfer to tertiary if possible.', NULL,
  'medium', 'obgyn', 'review',
  'ob_gyn', 'clinical_decision', 'obgyn', 'adult',
...
Cervix closed', '[{"label":"A","text":"Induce labor immediately"},{"label":"B","text":"PPROM (Preterm PROM) at 33 weeks: admit; expectant management to 34 wk if uncomplicated (balance prematurity vs infection risk); GBS prophylaxis (penicillin or alternatives); broad-spectrum antibiotic course — ampicillin + erythromycin (or azithromycin) × 7 days reduces chorioamnionitis + delivery latency (NICHD); antenatal corticosteroids (betamethasone × 2 doses) — fetal lung maturity; magnesium sulfate for neuroprotection < 32 wk; serial monitoring — fetal heart rate, uterine contractions, infection markers (WBC, CRP, fever), fluid color; delivery if: chorioamnionitis (fever, fetal tachycardia, uterine tenderness, foul fluid), non-reassuring fetal status, abruption, advanced labor, or reaching 34 wk; counsel; NICU notification"},{"label":"C","text":"Tocolyze long-term"},{"label":"D","text":"Discharge home"},{"label":"E","text":"Cesarean immediately"}]'::jsonb,
...
select
  s.id, 'board', NULL, 'อาจารย์อธิบาย physiology — labor + delivery + uterine contraction', '[{"label":"A","text":"No physiological coordination"},{"label":"B","text":"Labor Physiology — coordinated uterine activity: (1) Hormonal: ↑ estrogen + ↓ progesterone (functional withdrawal) → increased gap junction (connexin-43) → coordinated contractions; PGE2/F2α uterotonic + cervical ripening; oxytocin from posterior pituitary + receptors upregulated in myometrium late pregnancy; (2) Three phases of cervical change: cervical ripening (softening, late pregnancy), effacement, dilation; (3) Three phases of labor: latent (slow dilation, 0-6 cm), active (6-10 cm, ~1 cm/hr nulli, 1.5 cm/hr multi), 2nd stage (full dilation to delivery — pushing), 3rd stage (delivery of placenta); modern: latent up to 6 cm (vs old 4 cm — Friedman curve revised, Zhang); (4) Cardinal movements of labor (head): engagement → descent → flexion → internal rotation → extension → external rotation → expulsion; (5) Power, passenger, passage (Three P''s) determine progress; abnormal labor: protraction, arrest of dilation/descent; (6) Pain control: epidural (lumbar L3-4, blocks T10-L1 + S2-4 — ESM block), spinal, combined, opioids, nitrous oxide, non-pharmacologic; (7) Monitoring: intermittent vs continuous FHR (NICE — intermittent for low-risk; continuous if risk factors); (8) Augmentation: amniotomy, oxytocin titration; (9) Cesarean indications: NRFS, labor dystocia, abnormal presentation, placenta previa, etc."},{"label":"C","text":"Random uterine activity"},{"label":"D","text":"No hormonal control"},{"label":"E","text":"Same throughout pregnancy"}]'::jsonb,
  'B', 'Labor = coordinated uterine activity through hormonal + neurogenic + mechanical factors. Modern understanding (Zhang vs Friedman) — latent labor longer than thought, active phase begins ~ 6 cm. Cardinal movements describe fetal navigation through pelvis. Power/passenger/passage analysis identifies dystocia. Pain management options + risks. Continuous vs intermittent monitoring based on risk. Modern labor management = patient-centered + evidence-based.', NULL,
  'easy', 'obgyn', 'review',
  'ob_gyn', 'basic_science', 'obgyn', 'adult',
...
select
  s.id, 'board', NULL, 'Pediatric/Obstetric collaboration — reducing perinatal mortality + improving newborn outcomes', '[{"label":"A","text":"Pediatric + obstetric work separately"},{"label":"B","text":"Perinatal Care Integration — multidisciplinary obstetric + neonatal collaboration: (1) Pre-pregnancy: optimization (chronic disease, vaccinations, mental health, nutrition); (2) Antenatal: shared risk assessment, antenatal corticosteroid for preterm, MgSO4 for neuroprotection, GBS prophylaxis, level of care matching; (3) Intrapartum: skilled birth attendant, intermittent vs continuous monitoring, neonatal team alert for high-risk; (4) Delayed cord clamping 30-60 sec (improves iron stores, NEC, IVH); (5) Immediate skin-to-skin + early breastfeeding initiation; (6) Neonatal resuscitation if needed (NRP); (7) Newborn screening: pulse oximetry (CHD), hearing, blood spot (PKU, hypothyroid, CF, sickle cell, etc.), bilirubin; (8) NICU criteria + family involvement; (9) Postpartum: maternal screening (preeclampsia, depression, thyroid, infection, VTE, hemorrhage), breastfeeding support, contraception counseling; (10) Quality metrics: perinatal mortality rate, neonatal mortality, NICU admission, breastfeeding rates, preterm rate, c-section rate, severe morbidity; (11) Multidisciplinary team: obstetricians, midwives, neonatologists, anesthesia, lactation, social work, mental health, family medicine; (12) Continuity of care + transition"},{"label":"C","text":"Single specialty handles all"},{"label":"D","text":"Avoid newborn screening"},{"label":"E","text":"Discharge immediately"}]'::jsonb,
  'B', 'Perinatal care = integrative obstetric + neonatal + pediatric. Whole pregnancy journey + postpartum. Multidisciplinary team. Quality metrics. Outcomes improve with integrated care. Thai perinatal/neonatal mortality improving with system development. Family-centered. Continuous quality improvement.', NULL,
  'easy', 'obgyn', 'review',
  'ob_gyn', 'ems_mgmt', 'obgyn', 'adult',
...
where board_specialty = 'ob_gyn' and exam_source = 'AI-generated-board-seed'

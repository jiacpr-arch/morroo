-- ===============================================================
-- หมอรู้ — Board seed: ออร์โธปิดิกส์ (orthopedics) — 30 MCQs
...
-- 2/2 ─── 30 mcq_questions for orthopedics ─────────────
...
X-ray hip: displaced intracapsular femoral neck fracture left + Garden III', '[{"label":"A","text":"Non-operative + bedrest 6 weeks"},{"label":"B","text":"Displaced Intracapsular Femoral Neck Fracture (Garden III-IV) in elderly: high risk avascular necrosis (AVN) + nonunion (intracapsular blood supply tenuous) — surgical management within 24-48 hours (Cochrane evidence — earlier surgery lower mortality): hemiarthroplasty (if low demand, > 80, comorbidity) or total hip arthroplasty (THA — if active independent ambulator, < 75-80, better functional outcome long-term — HEALTH trial NEJM 2019); avoid internal fixation in elderly with displaced fracture (high AVN/nonunion); pre-op: optimize comorbidities, manage delirium (CAM), DVT prophylaxis, pain control (multimodal — avoid opioid-only, regional block — fascia iliaca compartment block), nutrition, geriatric consult; multidisciplinary care (ortho-geriatric co-management — Cochrane evidence reduces mortality + LOS); post-op: early mobilization, rehabilitation, fall prevention, osteoporosis screening + treatment (DEXA, bisphosphonate, vit D)"},{"label":"C","text":"Bracing only"},{"label":"D","text":"Amputation"},{"label":"E","text":"Discharge home with NSAIDs"}]'::jsonb,
  'B', 'Hip fracture in elderly: mortality 20-30% first year. Intracapsular displaced (Garden III-IV) — arthroplasty preferred over fixation due to high AVN risk. THA vs hemi: THA for active independent < 75-80; hemi for low-demand elderly. Early surgery < 48h reduces mortality (NICE, AAOS). Ortho-geriatric co-management improves outcomes. Multidisciplinary care + secondary prevention (osteoporosis Rx, fall prevention) essential.', NULL,
  'easy', 'trauma', 'review',
...
Intramuscular pressure right anterior compartment: 48 mmHg (normal < 30, perfusion pressure = DBP - compartment pressure = 82-48 = 34 — borderline)', '[{"label":"A","text":"Cast + observation"},{"label":"B","text":"Acute Compartment Syndrome (ACS) — clinical diagnosis + supportive measurement (5 P''s: Pain out of proportion + Pallor + Paresthesia + Paralysis + Pulselessness; pulselessness late finding): emergent fasciotomy (within 6 hours from onset of symptoms — irreversible muscle necrosis after 6-8 hours): (1) Remove constrictive bandage/cast immediately; (2) Limb at heart level (not elevated — reduces perfusion pressure); (3) IV fluid + maintain MAP; (4) Pain control; (5) **Emergent fasciotomy** — 4-compartment fasciotomy leg (anterior, lateral, deep posterior, superficial posterior) through 2 incisions (medial + lateral) — should not delay for confirmatory measurements if clinical signs; (6) Leave wounds open with VAC dressing — secondary closure or skin grafting 5-7 days later; (7) Treat underlying fracture (IMN tibial); (8) Monitor for rhabdomyolysis (CK, myoglobinuria) — IV fluid + bicarbonate + mannitol if needed, AKI risk; (9) Tetanus prophylaxis; (10) Long-term: contracture (Volkmann''s), nerve injury, chronic pain follow-up; (11) Multidisciplinary: ortho, vascular, plastic, ICU"},{"label":"C","text":"Diuretic + observation"},{"label":"D","text":"Amputation immediately"},{"label":"E","text":"Discharge with NSAIDs"}]'::jsonb,
  'B', 'Acute Compartment Syndrome (ACS): elevated pressure within osseofascial compartment → ischemia + necrosis. Most commonly leg (tibia fracture #1 cause). Clinical diagnosis. Pain out of proportion + passive stretch pain = early classic signs. Pulses preserved in many — pulselessness late. Compartment pressure > 30 mmHg or ΔP < 30 mmHg (DBP - compartment) = surgical. Emergent fasciotomy within 6h — irreversible after 6-8h. Don''t delay for confirmation if clinical. Complications: Volkmann''s contracture, nerve injury, rhabdo + AKI.', NULL,
...
EMG/NCV: median nerve conduction velocity slowed at wrist, no other neuropathy', '[{"label":"A","text":"Long-term opioid"},{"label":"B","text":"Carpal Tunnel Syndrome (CTS) — median nerve compression at wrist: (1) **Conservative first-line**: nocturnal wrist splint (neutral position — most effective single intervention), ergonomic modifications, activity modification, NSAIDs for pain, glucocorticoid injection (short-term improvement, lasts 1-3 mo); (2) Lifestyle: weight management, glycemic control if DM (predisposing); (3) Workplace ergonomics; (4) **Conservative usually trial 6-12 weeks**; (5) **Surgical decompression** indications: severe symptoms, thenar atrophy, motor deficit, failed conservative, severe EMG findings, persistent symptoms despite treatment; open vs endoscopic carpal tunnel release — equivalent outcomes, endoscopic faster return to work but slightly higher nerve injury risk; (6) Post-op: ROM exercises, gradual return to activity 4-6 weeks, full recovery 3-6 months; (7) Outcomes: 90% improvement with surgery; (8) Differential: cervical radiculopathy (C6-C7), thoracic outlet syndrome, pronator teres syndrome; (9) Bilateral common — assess both hands; (10) Pregnancy CTS often resolves postpartum"},{"label":"C","text":"Cast 6 months"},{"label":"D","text":"Amputation"},{"label":"E","text":"Discharge without treatment"}]'::jsonb,
  'B', 'CTS = most common upper extremity entrapment neuropathy. Median nerve compression at wrist (transverse carpal ligament). Risk: female, age, pregnancy, DM, hypothyroid, RA, obesity, repetitive use. Diagnosis: clinical + EMG/NCV. Conservative trial (splint, injection, NSAIDs) 6-12 wk. Surgical decompression for severe + failed conservative. Open vs endoscopic similar outcomes. > 90% improvement post-op.', NULL,
  'easy', 'neurology', 'review',
  'orthopedics', 'clinical_decision', 'neurology', 'adult',

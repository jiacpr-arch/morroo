-- ===============================================================
-- หมอรู้ — Board seed: อายุรศาสตร์ (internal_medicine) — Part 2/4 (Q51-100)
...
FLT3 negative', '[{"label":"A","text":"Standard 7+3 cytarabine + daunorubicin chemotherapy"},{"label":"B","text":"Acute promyelocytic leukemia (APL) with coagulopathy/DIC — Hematologic emergency: Start ATRA (all-trans retinoic acid) 45 mg/m² IMMEDIATELY on clinical suspicion (don''t wait for cytogenetic confirmation) + Arsenic trioxide (ATO) 0.15 mg/kg/d for low-intermediate risk per Lo-Coco APL0406 (ATRA + ATO without chemo); for high-risk (WBC > 10,000) add anthracycline (idarubicin) or gemtuzumab ozogamicin; aggressive coagulopathy support — transfuse cryoprecipitate to fibrinogen > 150, FFP, platelets > 30-50K (DIC + bleeding); monitor for differentiation syndrome (ATRA syndrome: fever, dyspnea, weight gain, infiltrates, hypoxia, hypotension) → dexamethasone 10 mg BID; tumor lysis prophylaxis (allopurinol/rasburicase, IV fluid); CNS prophylaxis high-risk; PCR monitoring of PML-RARA for MRD; aim cure rate > 90%"},{"label":"C","text":"Imatinib (BCR-ABL targeted)"},{"label":"D","text":"Watchful waiting until risk stratification complete"},{"label":"E","text":"Plasmapheresis for coagulopathy"}]'::jsonb,
  'B', 'Acute promyelocytic leukemia (APL) = AML-M3 with t(15;17) PML-RARA fusion. Distinct hematologic emergency due to early hemorrhagic death from DIC. NCCN + Sanz/PETHEMA APL guideline: (1) Start ATRA IMMEDIATELY on clinical suspicion — bilobed promyelocytes + Auer rods + DIC is the trigger; delay = death. (2) Frontline regimen: - Low/intermediate risk (WBC < 10,000): ATRA + ATO (APL0406 Lo-Coco NEJM 2013 — no chemotherapy, > 90% cure, lower toxicity). - High risk (WBC ≥ 10,000): ATRA + ATO + idarubicin or gemtuzumab ozogamicin (cytoreduction). (3) Coagulopathy support: aggressive blood products — fibrinogen > 150 mg/dL (cryoprecipitate), platelets > 30-50K, FFP for INR; daily monitoring DIC panel; avoid heparin/antifibrinolytics (no clear benefit; increase thrombosis with antifibrinolytics paradoxically). (4) Differentiation syndrome (formerly ATRA syndrome): fever, weight gain, infiltrates, effusions, hypotension, AKI; 25% incidence; dexamethasone 10 mg BID at first sign; continue ATRA unless severe. (5) Tumor lysis prophylaxis: hydration, allopurinol or rasburicase. (6) CNS prophylaxis: intrathecal MTX × 4-6 doses for high-risk. (7) Maintenance: ATRA ± 6MP + MTX × 2 yr in some protocols. (8) MRD monitoring: PCR PML-RARA q3 mo for 2 yr. APL cure rate now > 90% — was 0% pre-ATRA era. A ผิด — APL needs differentiation therapy, not 7+3. C ผิด — imatinib for CML/BCR-ABL. D ผิด — wait = bleed death. E ผิด — plasmapheresis no role.', NULL,

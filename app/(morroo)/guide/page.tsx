...
const sections = [
    ...
    content: [
      {
        ...
        text: "เลือกวิชาหรือสุ่มทุกวิชา ไม่จับเวลา เฉลยพร้อมคำอธิบายทันทีหลังตอบ สมาชิกฟรี: 5 ข้อ/วิชา | Premium: ไม่จำกัด",
      },
      {
  ...
  },
  {
    ...
    content: [
      ...
      },
      {
        ...
        text: "บัตรเครดิต/เดบิต หรือ PromptPay ผ่าน Stripe (เปิดใช้ทันที) ระบบจะเปิดสิทธิ์อัตโนมัติ + แจ้งเตือนทาง LINE และ Email",
      },
    ],
  },
  {
  ...
  },
  {
    id: "referral",
    icon: Users,
    title: "ชวนเพื่อน รับ 7 วันฟรี",
    content: [
      {
        subtitle: "วิธีใช้",
        text: "(1) ไปหน้า Profile กดสร้างรหัสชวนเพื่อน (2) คัดลอกลิงก์ส่งให้เพื่อน (3) เมื่อเพื่อนสมัคร + ซื้อแพ็กเกจ คุณได้ +7 วันทันที (สูงสุด 4 คนต่อปี)",
      },
    ],
  },
  {
...
const faqs = [
  { q: "สมาชิกฟรีทำอะไรได้บ้าง?", a: "สมัครใหม่ได้ทดลองทุกฟีเจอร์ฟรี 7 วัน (ครั้งเดียวต่อบัญชี) หลังจากนั้น: MCQ 5 ข้อ/วิชา, MEQ เคสฟรีพร้อม AI ตรวจคำตอบ 1 เคส, Long Case 1 เคส/เดือน" },
  { q: "ซื้อแล้วยกเลิกได้ไหม?", a: "แพ็กเกจเป็นแบบจ่ายครั้งเดียว ไม่ต่ออัตโนมัติ ไม่มี recurring charge ใช้ได้ตามจำนวนวันที่ซื้อ" },
  { q: "หมดอายุแล้วข้อมูลหายไหม?", a: "ไม่หาย ประวัติการทำข้อสอบ คะแนน สถิติ ยังอยู่ครบ แค่กลับไปใช้โควตาสมาชิกฟรี" },

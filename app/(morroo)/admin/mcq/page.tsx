    ...
    <div className="mx-auto max-w-6xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="flex items-center justify-between mb-6">
        ...
        <div className="flex items-center gap-2">
          <Link href="/admin/mcq/auto-answer">
            <Button variant="outline" className="gap-2">
              <Upload className="h-4 w-4" />เฉลยอัตโนมัติ (AI)
            </Button>
          </Link>
          <Link href="/admin/mcq/csv">
            <Button variant="outline" className="gap-2">
              <Upload className="h-4 w-4" />CSV เฉลย (Export/Seed)
            </Button>
          </Link>
          <Link href="/admin/mcq/cowork">
            <Button variant="outline" className="gap-2">
              <Upload className="h-4 w-4" />เฉลยด้วย cowork
            </Button>
          </Link>
          <Link href="/admin/mcq/import-pdf">
            <Button variant="outline" className="gap-2">
              <Upload className="h-4 w-4" />Import จาก PDF (AI)
            </Button>
          </Link>

...
import {
  ...
  preCourseVideos,
  getLessonQuizCount,
} from "@/lib/courses/bls/lessons";

export const metadata: Metadata = {
  title: "บทเรียน Pre-course",
  description: "บทเรียนย่อย BLS 8 บท แบบอ่าน-ควิซ-อ่าน อ้างอิง ILCOR 2025",
};
    ...
    <div className="mx-auto max-w-3xl px-4 py-12 sm:px-6 lg:px-8">
      ...
      <header className="mb-8">
        ...
        <p className="mt-2 text-muted-foreground">
          8 บทแบบ micro-learning — อ่านสั้น ๆ สลับควิซ พร้อมเฉลยทุกข้อ (อ้างอิง ILCOR 2025)
        </p>
      </header>

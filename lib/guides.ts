...
export const GUIDES: Guide[] = [
  ...
  },
  {
    ...
    sections: [
      ...
      },
      {
        ...
        body: [
          "หมอรู้มี MEQ Progressive Case 200+ เคสครอบคลุมทุกสาขา มีเคสตัวอย่างให้ลองฟรีไม่ต้องใส่บัตรเครดิต ใช้ AI ตรวจคำตอบฟรี 1 เคส รับ feedback แบบเดียวกับกรรมการสอบจริง",
        ],
      },
    ],
    relatedLinks: [
  ...
  },
  {
    ...
    sections: [
      ...
      {
        heading: "ฝึก MCQ 3,000+ ข้อฟรี — ลองได้ทันที",
        body: [
          "หมอรู้มี MCQ NL 3,000+ ข้อแบ่งตามสาขา พร้อมเฉลยพร้อมคำอธิบายทุกข้อ ใช้ AI วิเคราะห์จุดอ่อนและแนะนำข้อที่ควรทบทวน — ทดลองฟรี 5 ข้อต่อสาขาไม่ต้องใส่บัตรเครดิต",
        ],
      },
    ],
    relatedLinks: [

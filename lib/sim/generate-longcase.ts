...
7. **ช่วงอาจารย์ซักถาม (สำคัญมากต่อการเรียนรู้):** att_dech ถามคำถามจาก examiner_questions ทีละข้อเป็น choice (ข้อถูกมาจาก modelAnswer) แล้ว then เผยแนวทางคำตอบสั้นๆ 1 say — ทำ 3-4 ข้อสำคัญสุด เพื่อฝึก active recall เหมือนสอบ long case จริง
8. debrief แบบถาม-ตอบทีละประเด็น: teaching_points 2-3 ข้อ แต่ละข้อเป็น choice สั้นๆ ให้ผู้เล่นเลือกข้อความที่ถูก (tgt: "LEARN") แล้ว then เป็น say สรุป 1 บรรทัด → { "inter": "เคสสำเร็จ!!", "green": true } → { "end": true }

...
12. **ห้ามให้เดาข้อถูกได้จากรูปแบบตัวเลือก:** ทั้ง 3 label ใน choice เดียวกันต้องยาวใกล้เคียงกัน (ต่างกันไม่เกิน ~30%) โครงสร้างประโยคและระดับความเฉพาะเจาะจงขนานกัน — ห้ามให้ข้อถูกเป็นข้อที่ยาวสุด/ละเอียดสุด/มีตัวเลขมากสุดเป็นประจำ เขียนข้อถูกให้กระชับเหลือแก่นการตัดสินใจ (รายละเอียดเชิงสอนไปไว้ใน why/then) และเกลี่ยตัวลวงให้เฉพาะเจาะจงเท่ากัน

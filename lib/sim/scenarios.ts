  ...
  story: [
    ...
    { say: { who: "att_dech", pose: "stern", text: "ทั้งห้องหันมาที่คุณ… **คุณคือ Team Leader** — คำสั่งแรกของคุณจะกำหนดทุกอย่าง" }, t: 5 },
    {
      choice: {
        ...
        options: [
          ...
          { tgt: "CPR", label: "กดหน้าอกทันที ไม่ต้องเสียเวลาประเมิน", ok: false, why: "ยังไม่ยืนยันว่า arrest — ถ้าเป็นแค่เป็นลม การกดหน้าอกทำอันตรายได้" },
          { tgt: "DRUG", label: "เปิดเส้นฉีด Epinephrine ทันทีไม่ต้องรอ", ok: false, why: "ยังไม่รู้ด้วยซ้ำว่าหัวใจหยุดเต้น — ประเมินก่อนเสมอ" },
        ],
      },
    },
    {
      choice: {
        ...
        options: [
          ...
          { tgt: "MONITOR", label: "ติด 12-lead ECG ให้ครบก่อนทำอย่างอื่น", ok: false, why: "12-lead รอได้ ชีพจรรอไม่ได้" },
        ],
      },
    },
    {
      choice: {
        ...
        options: [
          {
            tgt: "CPR", label: "พี่บอย! กดหน้าอกเลย 100-120 ครั้ง/นาที", ok: true,
            then: [{ say: { who: "boy_compressor", pose: "talk", text: "รับทราบครับ! **เริ่มกด!** หนึ่ง-สอง-สาม-สี่…", fx: { cpr: true, firstCPR: true } }, t: 10 }],
          },
          { tgt: "DEFIB", label: "รอเครื่อง defib มาก่อนแล้วค่อยเริ่มกด", ok: false, why: "ห้ามรอเด็ดขาด — สมองขาดออกซิเจนทุกวินาที", worsen: true },
          { tgt: "AIRWAY", label: "หยุดกดชั่วคราวเพื่อใส่ท่อช่วยหายใจก่อน", ok: false, why: "CPR มาก่อน advanced airway เสมอในนาทีแรก" },
        ],
      },
    },
    { say: { who: "fon_defib", pose: "talk", text: "Crash cart มาแล้วค่ะ! เครื่อง defib พร้อม!" }, t: 15 },
    {
      choice: {
        ...
        options: [
          {
            tgt: "MONITOR", label: "แปะ pads ดู rhythm โดยหยุดกดสั้นที่สุด", ok: true,
            then: [
          ...
          { tgt: "DRUG", label: "เปิด IV ฉีด Epinephrine ก่อนค่อยดูจอ", ok: false, why: "ต้องรู้ rhythm ก่อน — shockable หรือไม่ เปลี่ยนแผนทั้งหมด" },
          { tgt: "YOU", label: "สั่งหยุดกดยาวๆ เพื่ออ่านจอให้ชัดเจน", ok: false, why: "หยุดกดให้สั้นที่สุด — hands-off time คือศัตรูตัวจริง", worsen: true },
        ],
      },
    },
    {
      choice: {
        ...
        options: [
          ...
          { tgt: "DEFIB", label: "เริ่มพลังงานต่ำ 50 J เพื่อความปลอดภัย", ok: false, why: "ต่ำเกินไป — VF ผู้ใหญ่ใช้ 120-200 J (biphasic)" },
          { tgt: "DRUG", label: "ให้ Amiodarone 300 mg ก่อนค่อย shock", ok: false, why: "ไฟฟ้ามาก่อนยาเสมอใน shockable rhythm" },
        ],
      },
    },
    {
    ...
    },
    {
      choice: {
        ...
        options: [
          ...
          { tgt: "YOU", label: "หยุดกดเพื่อคลำชีพจรให้แน่ใจก่อน", ok: false, why: "หัวใจหลัง shock ยังอ่อนแรง — CPR ต่อทันที 2 นาทีก่อนเช็ค" },
          { tgt: "DRUG", label: "หยุดรอดูผลของไฟสักครู่ก่อนไปต่อ", ok: false, why: 'ไม่มีจังหวะไหนที่ "หยุดรอ" ใน cardiac arrest', worsen: true },
        ],
      },
    },
    {
      choice: {
        ...
        options: [
          ...
          { tgt: "DRUG", label: "Shock 200 J + Atropine 1 mg IV ตามทันที", ok: false, why: "Atropine ไม่มีที่ใน VF — ใช้ใน bradycardia" },
          { tgt: "DRUG", label: "Shock 200 J + Adenosine 6 mg IV push เร็ว", ok: false, why: "Adenosine ใช้ใน SVT ที่มีชีพจร — ไม่ใช่ที่นี่" },
        ],
      },
    },
    {
      choice: {
        ...
        options: [
          ...
          { tgt: "DRUG", label: "Shock ครั้งที่ 3 + Epinephrine 5 mg เพิ่มขนาด", ok: false, why: "ขนาดผิด — Epi ใน arrest คือ 1 mg เสมอ ทุก 3-5 นาที" },
          { tgt: "YOU", label: "ประกาศยุติการกู้ชีพ — ทำเต็มที่แล้ว", ok: false, why: "เร็วเกินไปมาก — VF ที่ยังสั่นคือหัวใจที่ยังสู้อยู่", worsen: true },
        ],
      },
    },
    {
      choice: {
        ...
        options: [
          {
            tgt: "YOU", label: "หยุด CPR เริ่ม post-arrest care + 12-lead", ok: true,
            then: [
          ...
          { tgt: "CPR", label: "กดหน้าอกต่ออีก 2 นาทีเผื่อหยุดซ้ำ", ok: false, why: "มีชีพจรแล้ว — การกดต่อทำร้ายหัวใจที่เพิ่งกลับมา" },
          { tgt: "DEFIB", label: "Shock ซ้ำอีกหนึ่งครั้งเพื่อความมั่นใจ", ok: false, why: "Shock จังหวะปกติ = ทำให้ arrest ซ้ำ อันตรายที่สุด", worsen: true },
        ],
      },
    },
    { end: true },
  ...
  story: [
        ...
        options: [
          {
            ...
            then: [{ say: { who: "patient_young_male", pose: "panic", text: "ปวดขึ้นมา**ทันที**ตอนตื่นนอนครับ ปวดมากขึ้นเรื่อยๆ… เมื่อ 2 เดือนก่อนเคยปวดแบบนี้แล้ว**หายเอง**" }, t: 8 }],
          },
        ...
        options: [
          {
            ...
            then: [{ say: { who: "patient_young_male", pose: "talk", text: "**ไม่มี**ปัสสาวะแสบขัด ไม่มีไข้ครับ แต่คลื่นไส้ อาเจียนไป 1 ครั้ง" }, t: 7 }],
          },
...

    {
      choice: {
        ...
        options: [
          ...
          { tgt: "PE", label: "ตรวจร่างกายระบบประสาทอย่างเต็มรูปแบบ", ok: false, why: "ไม่เกี่ยวกับภาวะนี้ เสียเวลาโดยเปล่าประโยชน์" },
        ],
      },
    },
    {
...

    {
      choice: {
        ...
        options: [
          {
            tgt: "LAB", label: "ส่ง UA + CBC + Doppler US พร้อมปรึกษาศัลย์", ok: true,
...

    {
      choice: {
        ...
        options: [
          ...
          { tgt: "DX", label: "Epididymo-orchitis (อัณฑะอักเสบ)", ok: false, why: "มักค่อยเป็นค่อยไป มีไข้/ปัสสาวะแสบขัด และ cremasteric reflex ยังอยู่ — ไม่ตรงเคสนี้" },
          { tgt: "DX", label: "Incarcerated inguinal hernia (ไส้เลื่อน)", ok: false, why: "จะคลำได้ก้อนที่ขาหนีบและมีอาการลำไส้อุดตันร่วม — ไม่ตรง" },
        ],
      },
    },

    {
      choice: {
        ...
        options: [
          {
            tgt: "MGMT", label: "เข้า OR explore + detorsion ฉุกเฉินทันที", ok: true,
            then: [{ say: { who: "att_dech", pose: "stern", text: "ถูกต้อง — เข้าห้องผ่าตัดด่วน ยิ่งเร็วยิ่งดี **รักษาอัณฑะได้ >90% ถ้าภายใน 6 ชม.**" }, t: 6 }],
          },
          { tgt: "MGMT", label: "ให้ยาปฏิชีวนะครบชุดแล้วนัดติดตามอาการ", ok: false, worsen: true, why: "นี่ไม่ใช่การติดเชื้อ — ให้ ATB แล้วปล่อยกลับ = เสียอัณฑะ" },
          { tgt: "MGMT", label: "ให้ยาแก้ปวด ประคบเย็น แล้วให้กลับบ้าน", ok: false, worsen: true, why: "เป็นภาวะฉุกเฉินผ่าตัด ห้ามให้กลับบ้านเด็ดขาด" },
        ],
      },
    },
    {
      choice: {
        ...
        options: [
          {
            tgt: "MGMT", label: "เพราะ bell-clapper deformity มักเป็นสองข้าง", ok: true,
          ...
          { tgt: "MGMT", label: "ไม่จำเป็น — fix เฉพาะข้างที่บิดก็เพียงพอ", ok: false, why: "พลาดจุดสำคัญ — อีกข้างเสี่ยงบิดเพราะ anatomy ผิดปกติทั้งคู่" },
          { tgt: "MGMT", label: "ต้องตัดอัณฑะทิ้งทั้งสองข้างกันเป็นซ้ำ", ok: false, why: "ตัด (orchiectomy) เฉพาะเมื่อเนื้อตายแล้วเท่านั้น ไม่ใช่ทำเป็น routine" },
        ],
      },
    },

...
import { welcomeEmail, receiptEmail, weeklyNewsletterEmail, weeklyDigestEmail, redeemCodeEmail } from "./templates";
import type {
  WelcomeEmailProps,
  ReceiptEmailProps,
  NewsletterPost,
...
export async function sendRedeemCodeEmail(props: RedeemCodeEmailProps) {
  return sendEmail({
    to: props.email,

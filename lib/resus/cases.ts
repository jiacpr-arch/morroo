...
const SHOULDER = { cx: 360, cy: 255, r: 60 };
  ...
  steps: [
    {
      ...
      tool: "hands",
      zone: { shape: "circle", ...SHOULDER },
      gesture: { kind: "tap" },
      rhythm: "vf",
      why: "**ตบไหล่เรียกดัง ๆ** ก่อนเสมอ — ไม่ตอบสนอง ให้ **ตะโกนเรียกทีม + สั่งเอาเครื่อง defib/monitor มา** ทันที",
      wrongToolWhy: {
    ...
    },
    {
      ...
      hpDrain: true,
      why: "คลำ carotid **พร้อมดูการหายใจไปด้วยไม่เกิน 10 วินาที** — ไม่มีชีพจร/หายใจเฮือก = เริ่ม CPR ทันที",
    },
    {
      id: "cpr-1",
    ...
    {
      id: "shock-1",
      title: "ช็อกไฟฟ้าครั้งที่ 1 (ภายใน 45 วิ)",
      tool: "defib_button",
      ...
      wrongToolWhy: {
        ...
        syringe_epi: "ยังไม่ช็อกครั้งแรกเลย — **ช็อกก่อน** ค่อยให้ยาหลังช็อกครั้งที่ 2",
      },
    },
    {
      id: "iv",
      title: "เปิดเส้น IV (ระหว่างปั๊มต่อ)",
      tool: "iv_catheter",
      ...
      rhythm: "vf",
      fxState: "iv_in",
      why: "ระหว่างปั๊มต่อให้เปิดเส้นเลือดใหญ่ไว้ให้ยา — ถ้าเปิด IV ไม่ได้ ใช้ **IO (intraosseous)** แทนได้",
    },
    {
      id: "cpr-2",
    ...
    {
      id: "shock-2",
      title: "ช็อกไฟฟ้าครั้งที่ 2 (ภายใน 45 วิ)",
      tool: "defib_button",
      zone: { shape: "circle", ...DEFIB },
      gesture: { kind: "tap" },
      hpDrain: true,
      ...
      wrongToolWhy: {
        syringe_amio: "Amiodarone รอหลังช็อก**ครั้งที่ 3** — ตอนนี้ยังไม่ถึงคิว",
      },
    },
    {
      id: "epi",
      title: "ให้ Epinephrine 1 mg (หลังช็อกครั้งที่ 2)",
      tool: "syringe_epi",
      zone: { shape: "circle", ...ARM_IV },
      gesture: { kind: "tap" },
      hpDrain: true,
      rhythm: "vf",
      why: "จังหวะ shockable ให้ยา**หลังช็อก** ไม่ใช่ก่อน — **Epi โดสแรกหลังช็อกครั้งที่ 2** แล้วซ้ำทุก 3-5 นาที",
      wrongToolWhy: {
    ...
    },
    {
      ...
      hpDrain: true,
      rhythm: "vf",
      why: "ให้ Epi แล้วปั๊มต่อทันที **2 นาที** ก่อนช็อกรอบถัดไป",
    },
    {
      id: "shock-3",
      title: "ช็อกไฟฟ้าครั้งที่ 3 (ภายใน 45 วิ)",
      tool: "defib_button",
      zone: { shape: "circle", ...DEFIB },
      gesture: { kind: "tap" },
      hpDrain: true,
      ...
      rhythm: "vf",
      fxState: "shock_flash",
      why: "ยังดื้อต่อการช็อก — **VF/pVT ที่ดื้อ** ต้องเสริมยาต้านหัวใจเต้นผิดจังหวะ",
    },
    {
      id: "amio",
      title: "ให้ Amiodarone 300 mg (หลังช็อกครั้งที่ 3)",
      tool: "syringe_amio",
      zone: { shape: "circle", ...ARM_IV },
      gesture: { kind: "tap" },
      hpDrain: true,
      rhythm: "vf",
      why: "VF ดื้อการช็อก → **Amiodarone 300 mg IV หลังช็อกครั้งที่ 3** (ให้ซ้ำ 150 mg ได้อีกครั้ง)",
      wrongToolWhy: {
        syringe_epi: "Epi ให้ไปแล้วหลังช็อกครั้งที่ 2 — **ตามด้วย Epi ทุก 3-5 นาที** ไปเรื่อยๆ ระหว่างนี้ให้ Amio ก่อน",
      },
    },
    {
      id: "cpr-rosc",
...
// ============================================================
// ด่าน 2 — PEA: จังหวะลวงตา
// ============================================================
const PEA_ARREST: Operation = {
  slug: "pea-arrest-01",
  title: "PEA: จังหวะลวงตา",
...
const AIRWAY_ROSC: Operation = {
  ...
  steps: [
    ...
    },
    {
      ...
      rhythm: "nsr",
      fxState: "saline_running",
      why: "Post-ROSC bundle: คุม **MAP ≥ 65 mmHg** ด้วยสารน้ำ/vasopressor, ตรวจ **12-lead ECG หา STEMI → cath lab**, และพิจารณา **TTM คุมอุณหภูมิ 32-36°C** เลี่ยงไข้",
    },
  ],
};

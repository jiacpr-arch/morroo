...
export const PRICING_FAQ_ITEMS: { q: string; a: string }[] = [
  {
    ...
    a: "สมัครแล้วทดลองทุกฟีเจอร์ฟรี 7 วันทันที (ครั้งเดียวต่อบัญชี) ไม่ต้องใส่บัตรเครดิต หลังหมดสิทธิ์ยังใช้ฟรีต่อได้ — MCQ 5 ข้อต่อสาขา · MEQ + AI ตรวจ 1 เคส · Long Case 1 เคสต่อเดือน",
  },
  {
  ...
  {
    q: "ราคาพิเศษซื้อครั้งแรกคืออะไร?",
    a: "สมาชิกที่ยังไม่เคยซื้อแพ็กใดมาก่อน จ่ายราคาพิเศษสำหรับคำสั่งซื้อแรก (ราคาปกติแสดงเป็นราคาขีดฆ่า) หลังจากนั้นซื้อหรือต่ออายุครั้งถัดไปเป็นราคาปกติ ใช้ได้กับแพ็กรายเดือนและรายปีทุกแทร็ก",
  },
  {

...
export const PRICING_FAQ_ITEMS: { q: string; a: string }[] = [
  {
    ...
    a: "ทดลองฟรีได้ทันที — MCQ 5 ข้อต่อสาขา · MEQ เคสตัวอย่าง · Long Case 1 เคสต่อเดือน ไม่ต้องใส่บัตรเครดิต ใช้เวลาสมัครแค่ 30 วินาที",
  },
  {
  ...
  },
  {
    ...
    a: "บัตรเครดิต/เดบิตทุกประเภท หรือ PromptPay ผ่าน Stripe เปิดใช้งานทันทีหลังชำระเงิน ปลอดภัยระดับสากล",
  },
  {
  ...
  },
  {
    ...
    a: "ทุกครั้งที่เพื่อนสมัครและซื้อแพ็กเกจผ่านลิงก์ของคุณ — เราจะต่ออายุสมาชิกของคุณ +7 วันฟรี (รับได้สูงสุด 4 คนต่อปี) รหัสแชร์อยู่ในหน้า Profile",
  },
];
